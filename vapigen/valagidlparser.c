...
static void vala_gidl_parser_parse_file (ValaGIdlParser* self, ValaSourceFile* source_file) {
	...
	}
	{
		...
		_tmp61_ = source_file;
		_tmp62_ = vala_source_reference_new (_tmp61_, 0, 0, 0, 0);
		_vala_source_reference_unref0 (self->priv->current_source_reference);
		self->priv->current_source_reference = _tmp62_;
		{
			...
			for (module_it = module_collection; module_it != NULL; module_it = module_it->next) {
				...
				module = (GIdlModule*) module_it->data;
				{
					...
					_tmp63_ = module;
					_tmp64_ = vala_gidl_parser_parse_module (self, _tmp63_);
					ns = _tmp64_;
					_tmp65_ = ns;
					if (_tmp65_ != NULL) {
						...
						_tmp67_ = vala_code_context_get_root (_tmp66_);
						_tmp68_ = _tmp67_;
						_tmp69_ = ns;
						vala_symbol_add_namespace ((ValaSymbol*) _tmp68_, _tmp69_);
					}
	...
	__catch1_g_markup_error:
	{
		...
		_tmp72_ = g_strdup_printf ("Unable to parse GIDL file: %s", _tmp71_);
		_tmp73_ = _tmp72_;
...
static gchar* vala_gidl_parser_get_cname (ValaGIdlParser* self, ValaSymbol* sym, ValaSymbol* container) {
	...
	if (VALA_IS_METHOD (_tmp7_)) {
		...
		name = _tmp11_;
		_tmp12_ = sym;
		if (VALA_IS_CREATION_METHOD (_tmp12_)) {
...
static gchar* vala_gidl_parser_get_lower_case_cprefix (ValaGIdlParser* self, ValaSymbol* sym) {
	...
	if (_tmp7_ == NULL) {
		...
		gboolean _tmp11_;
		_tmp9_ = sym;
		if (VALA_IS_OBJECT_TYPE_SYMBOL (_tmp9_)) {
			_tmp8_ = TRUE;
		} else {
			ValaSymbol* _tmp10_;
			_tmp10_ = sym;
			_tmp8_ = VALA_IS_STRUCT (_tmp10_);
		}
		_tmp11_ = _tmp8_;
		_tmp6_ = _tmp11_;
	} else {
...
gchar* vala_gidl_parser_get_cprefix (ValaGIdlParser* self, ValaSymbol* sym) {
	...
	if (VALA_IS_OBJECT_TYPE_SYMBOL (_tmp0_)) {
		...
		gboolean _tmp6_;
		_tmp4_ = sym;
		if (VALA_IS_ENUM (_tmp4_)) {
			_tmp3_ = TRUE;
		} else {
			ValaSymbol* _tmp5_;
			_tmp5_ = sym;
			_tmp3_ = VALA_IS_ERROR_DOMAIN (_tmp5_);
		}
		_tmp6_ = _tmp3_;
		if (_tmp6_) {
			ValaSymbol* _tmp7_;
...
static void vala_gidl_parser_add_symbol_to_container (ValaGIdlParser* self, ValaSymbol* container, ValaSymbol* sym) {
	...
	_tmp113_ = sym;
	if (!VALA_IS_NAMESPACE (_tmp113_)) {
		ValaSymbol* _tmp114_;
		_tmp114_ = container;
		_tmp112_ = VALA_IS_NAMESPACE (_tmp114_);
	} else {
		_tmp112_ = FALSE;
	}
	_tmp115_ = _tmp112_;
	...
	_tmp15__length1 = path_length1;
	{
		...
		for (tok_it = 0; tok_it < _tmp15__length1; tok_it = tok_it + 1) {
			...
			tok = tok_collection[tok_it];
			{
				...
				cc = VALA_IS_SYMBOL (_tmp20_) ? ((ValaSymbol*) _tmp20_) : NULL;
				_tmp21_ = cc;
				if (_tmp21_ == NULL) {
					const gchar* _tmp22_;
...
static ValaNamespace* vala_gidl_parser_parse_module (ValaGIdlParser* self, GIdlModule* module) {
	...
	if (VALA_IS_NAMESPACE (_tmp8_)) {
		...
		gboolean _tmp13_;
		_tmp9_ = sym;
		_tmp10_ = _vala_code_node_ref0 (VALA_NAMESPACE (_tmp9_));
		_vala_code_node_unref0 (ns);
		ns = _tmp10_;
		_tmp11_ = ns;
	...
	_tmp88_ = vala_array_list_new (G_TYPE_POINTER, NULL, NULL, _tmp87_);
	deferred = _tmp88_;
	_tmp89_ = module;
	_tmp90_ = _tmp89_->entries;
	{
		GList* node_collection = NULL;
		GList* node_it = NULL;
		node_collection = _tmp90_;
		for (node_it = node_collection; node_it != NULL; node_it = node_it->next) {
			...
			node = (GIdlNode*) node_it->data;
			{
				...
				is_deferred = FALSE;
				_tmp91_ = node;
				_tmp93_ = vala_gidl_parser_get_attributes_for_node (self, _tmp91_, &_tmp92_);
				child_attributes = _tmp93_;
				child_attributes_length1 = _tmp92_;
				_child_attributes_size_ = child_attributes_length1;
				_tmp94_ = child_attributes;
				_tmp94__length1 = child_attributes_length1;
				if (_tmp94_ != NULL) {
					gchar** _tmp95_;
					gint _tmp95__length1;
					_tmp95_ = child_attributes;
					_tmp95__length1 = child_attributes_length1;
					{
						gchar** attr_collection = NULL;
						gint attr_collection_length1 = 0;
						gint _attr_collection_size_ = 0;
						gint attr_it = 0;
						attr_collection = _tmp95_;
						attr_collection_length1 = _tmp95__length1;
						for (attr_it = 0; attr_it < _tmp95__length1; attr_it = attr_it + 1) {
							...
							attr = attr_collection[attr_it];
							{
								...
								_tmp96_ = attr;
								_tmp98_ = _tmp97_ = g_strsplit (_tmp96_, "=", 2);
								nv = _tmp98_;
								nv_length1 = _vala_array_length (_tmp97_);
								_nv_size_ = nv_length1;
								_tmp99_ = nv;
								_tmp99__length1 = nv_length1;
								_tmp100_ = _tmp99_[0];
								if (g_strcmp0 (_tmp100_, "parent") == 0) {
									ValaArrayList* _tmp101_;
									GIdlNode* _tmp102_;
									_tmp101_ = deferred;
									_tmp102_ = node;
									vala_collection_add ((ValaCollection*) _tmp101_, _tmp102_);
									is_deferred = TRUE;
								}
								nv = (_vala_array_free (nv, nv_length1, (GDestroyNotify) g_free), NULL);
							}
				...
				if (!_tmp103_) {
					...
					_tmp105_ = module;
					_tmp106_ = ns;
					vala_gidl_parser_parse_node (self, _tmp104_, _tmp105_, (ValaSymbol*) _tmp106_);
				}
	...
	}
	{
		...
		while (TRUE) {
			...
			GIdlModule* _tmp141_;
			ValaSymbol* _tmp142_;
			ValaNamespace* _tmp143_;
			ValaNamespace* _tmp144_;
			_tmp112_ = _node_index;
			_node_index = _tmp112_ + 1;
			...
			_tmp115_ = _node_list;
			_tmp116_ = _node_index;
			_tmp117_ = vala_list_get ((ValaList*) _tmp115_, _tmp116_);
			node = (GIdlNode*) _tmp117_;
			_tmp118_ = ns;
			_tmp119_ = _vala_code_node_ref0 ((ValaSymbol*) _tmp118_);
			container = _tmp119_;
			_tmp120_ = node;
			_tmp122_ = vala_gidl_parser_get_attributes_for_node (self, _tmp120_, &_tmp121_);
			child_attributes = _tmp122_;
			child_attributes_length1 = _tmp121_;
			_child_attributes_size_ = child_attributes_length1;
			_tmp123_ = child_attributes;
			_tmp123__length1 = child_attributes_length1;
			if (_tmp123_ != NULL) {
				gchar** _tmp124_;
				gint _tmp124__length1;
				_tmp124_ = child_attributes;
				_tmp124__length1 = child_attributes_length1;
				{
					gchar** attr_collection = NULL;
					gint attr_collection_length1 = 0;
					gint _attr_collection_size_ = 0;
					gint attr_it = 0;
					attr_collection = _tmp124_;
					attr_collection_length1 = _tmp124__length1;
					for (attr_it = 0; attr_it < _tmp124__length1; attr_it = attr_it + 1) {
						const gchar* attr = NULL;
						attr = attr_collection[attr_it];
						{
							...
							_tmp125_ = attr;
							_tmp127_ = _tmp126_ = g_strsplit (_tmp125_, "=", 2);
							nv = _tmp127_;
							nv_length1 = _vala_array_length (_tmp126_);
							_nv_size_ = nv_length1;
							_tmp128_ = nv;
							_tmp128__length1 = nv_length1;
							_tmp129_ = _tmp128_[0];
							if (g_strcmp0 (_tmp129_, "parent") == 0) {
								gchar** _tmp130_;
								...
								_tmp133_ = _tmp132_;
								_tmp134_ = vala_gidl_parser_get_container_from_name (self, _tmp133_);
			...
			_tmp135_ = container;
			if (VALA_IS_NAMESPACE (_tmp135_)) {
				ValaSymbol* _tmp136_;
				ValaNamespace* _tmp137_;
				_tmp136_ = container;
				_tmp137_ = _vala_code_node_ref0 (VALA_NAMESPACE (_tmp136_));
				_vala_code_node_unref0 (self->priv->current_namespace);
				self->priv->current_namespace = _tmp137_;
			} else {
				ValaSymbol* _tmp138_;
				ValaTypeSymbol* _tmp139_;
				_tmp138_ = container;
				_tmp139_ = _vala_code_node_ref0 (VALA_TYPESYMBOL (_tmp138_));
				_vala_code_node_unref0 (self->priv->current_data_type);
				self->priv->current_data_type = _tmp139_;
			}
			_tmp140_ = node;
			_tmp141_ = module;
			_tmp142_ = container;
			vala_gidl_parser_parse_node (self, _tmp140_, _tmp141_, _tmp142_);
			_tmp143_ = ns;
			_tmp144_ = _vala_code_node_ref0 (_tmp143_);
			_vala_code_node_unref0 (self->priv->current_namespace);
			self->priv->current_namespace = _tmp144_;
			_vala_code_node_unref0 (self->priv->current_data_type);
											...
											if (g_strcmp0 (_tmp250_, "is_out") == 0) {
												...
												if (_tmp255_) {
													...
													if (!_tmp258_) {
														...
														_tmp259_ = param_type;
														_tmp257_ = VALA_IS_ARRAY_TYPE (_tmp259_);
													} else {
														_tmp257_ = FALSE;
													}
													_tmp260_ = _tmp257_;
													if (_tmp260_) {
														...
														_tmp261_ = param_type;
														_tmp262_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp261_));
														array_type = _tmp262_;
														_tmp263_ = array_type;
												...
												if (g_strcmp0 (_tmp270_, "is_ref") == 0) {
													...
													if (_tmp275_) {
														...
														if (!_tmp278_) {
															...
															_tmp279_ = param_type;
															_tmp277_ = VALA_IS_ARRAY_TYPE (_tmp279_);
														} else {
															_tmp277_ = FALSE;
														}
														_tmp280_ = _tmp277_;
														if (_tmp280_) {
															...
															_tmp281_ = param_type;
															_tmp282_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp281_));
															array_type = _tmp282_;
															_tmp283_ = array_type;
...
static void vala_gidl_parser_parse_struct (ValaGIdlParser* self, GIdlNodeStruct* st_node, ValaSymbol* container, GIdlModule* module) {
	...
	if (!_tmp9_) {
		...
		st = VALA_IS_STRUCT (_tmp14_) ? ((ValaStruct*) _tmp14_) : NULL;
		_tmp15_ = st;
		if (_tmp15_ == NULL) {
			const gchar* _tmp16_;
		...
		cl = VALA_IS_CLASS (_tmp164_) ? ((ValaClass*) _tmp164_) : NULL;
		_tmp165_ = cl;
		if (_tmp165_ == NULL) {
			gchar* base_class;
				...
				member = (GIdlNode*) member_it->data;
				{
					...
					if (_tmp323_ == G_IDL_NODE_FUNCTION) {
						...
						if (_tmp328_) {
							...
							_tmp336_ = _tmp335_;
							ref_function_void = VALA_IS_VOID_TYPE (_tmp336_);
				...
				member = (GIdlNode*) member_it->data;
				{
					...
					if (_tmp140_ == G_IDL_NODE_FUNCTION) {
						...
						if (g_strcmp0 (_tmp142_, "ref") == 0) {
							...
							_tmp150_ = _tmp149_;
							ref_function_void = VALA_IS_VOID_TYPE (_tmp150_);
...
static void vala_gidl_parser_parse_boxed (ValaGIdlParser* self, GIdlNodeBoxed* boxed_node, ValaSymbol* container, GIdlModule* module) {
	...
	if (!_tmp19_) {
		...
		st = VALA_IS_STRUCT (_tmp24_) ? ((ValaStruct*) _tmp24_) : NULL;
		_tmp25_ = st;
		if (_tmp25_ == NULL) {
			const gchar* _tmp26_;
		...
		cl = VALA_IS_CLASS (_tmp127_) ? ((ValaClass*) _tmp127_) : NULL;
		_tmp128_ = cl;
		if (_tmp128_ == NULL) {
			gchar* base_class;
			const gchar* _tmp129_;
				...
				member = (GIdlNode*) member_it->data;
				{
					...
					if (_tmp249_ == G_IDL_NODE_FUNCTION) {
						...
						if (g_strcmp0 (_tmp251_, "ref") == 0) {
							...
							_tmp259_ = _tmp258_;
							ref_function_void = VALA_IS_VOID_TYPE (_tmp259_);
...
static void vala_gidl_parser_parse_enum (ValaGIdlParser* self, GIdlNodeEnum* en_node, ValaSymbol* container, GIdlModule* module, gboolean is_flags) {
	...
	en = VALA_IS_ENUM (_tmp9_) ? ((ValaEnum*) _tmp9_) : NULL;
	_tmp10_ = en;
	if (_tmp10_ == NULL) {
		const gchar* _tmp11_;
		ValaSourceReference* _tmp12_;
...
static void vala_gidl_parser_parse_object (ValaGIdlParser* self, GIdlNodeInterface* node, ValaSymbol* container, GIdlModule* module) {
	...
	cl = VALA_IS_CLASS (_tmp8_) ? ((ValaClass*) _tmp8_) : NULL;
	_tmp9_ = cl;
	if (_tmp9_ == NULL) {
		const gchar* _tmp10_;
		ValaSourceReference* _tmp11_;
...
static void vala_gidl_parser_parse_interface (ValaGIdlParser* self, GIdlNodeInterface* node, ValaSymbol* container, GIdlModule* module) {
	...
	_tmp7_ = name;
	_tmp8_ = vala_scope_lookup (_tmp6_, _tmp7_);
	iface = VALA_IS_INTERFACE (_tmp8_) ? ((ValaInterface*) _tmp8_) : NULL;
	_tmp9_ = iface;
	if (_tmp9_ == NULL) {
		const gchar* _tmp10_;
		ValaSourceReference* _tmp11_;
	...
	methods = _tmp4_;
	{
		...
		while (TRUE) {
			...
			if (_tmp18_) {
				...
				_tmp45_ = VALA_IS_METHOD (_tmp44_) ? ((ValaMethod*) _tmp44_) : NULL;
				_g_free0 (_tmp43_);
																			...
																			if (_tmp96_ == TYPE_TAG_UTF8) {
																				...
																				if (_tmp101_ == TYPE_TAG_FILENAME) {
																					...
																					if (_tmp106_ == TYPE_TAG_ARRAY) {
																						...
																						_tmp111_ = _vala_code_node_ref0 (VALA_IS_UNRESOLVED_TYPE (_tmp110_) ? ((ValaUnresolvedType*) _tmp110_) : NULL);
																						_vala_code_node_unref0 (type);
																						type = _tmp111_;
																						_tmp112_ = type;
																						if (_tmp112_ == NULL) {
																																											...
																																											if (g_strcmp0 (_tmp260_, "iconv_t") == 0) {
																																												...
																																												if (g_strcmp0 (_tmp265_, "GType") == 0) {
																																													...
																																													if (g_strcmp0 (_tmp278_, "GStrv") == 0) {
																																														...
																																														named_type = _tmp288_;
																																														_tmp289_ = named_type;
																																														_tmp290_ = _vala_code_node_ref0 (VALA_IS_UNRESOLVED_TYPE (_tmp289_) ? ((ValaUnresolvedType*) _tmp289_) : NULL);
																																														_vala_code_node_unref0 (type);
																																														type = _tmp290_;
																																														_tmp291_ = type;
																																														if (_tmp291_ == NULL) {
...
static gboolean vala_gidl_parser_is_simple_type (ValaGIdlParser* self, const gchar* type_name) {
	...
	st = VALA_IS_STRUCT ((ValaTypeSymbol*) _tmp2_) ? ((ValaStruct*) ((ValaTypeSymbol*) _tmp2_)) : NULL;
	_tmp4_ = st;
	if (_tmp4_ != NULL) {
		ValaStruct* _tmp5_;
		gboolean _tmp6_ = FALSE;
...
static ValaField* vala_gidl_parser_parse_field (ValaGIdlParser* self, GIdlNodeField* field_node) {
	...
	if (_tmp181_) {
		...
		_tmp190_ = _tmp189_;
		if (VALA_IS_ARRAY_TYPE (_tmp190_)) {
			ValaField* _tmp191_;
			_tmp191_ = field;
...
static ValaSignal* vala_gidl_parser_parse_signal (ValaGIdlParser* self, GIdlNodeSignal* sig_node) {
	...
	if (_tmp30_ != NULL) {
		...
		if (_tmp126_ != NULL) {
			...
			_tmp129_ = _tmp128_;
			_tmp130_ = vala_unresolved_type_get_unresolved_symbol (VALA_UNRESOLVED_TYPE (_tmp129_));
			_tmp131_ = _tmp130_;
			_tmp132_ = ns_name;
			...
			param = (GIdlNodeParam*) param_it->data;
			{
				...
				if (_tmp161_ != NULL) {
					...
					if (_tmp271_ != NULL) {
						...
						_tmp272_ = param_type;
						_tmp273_ = vala_unresolved_type_get_unresolved_symbol (VALA_UNRESOLVED_TYPE (_tmp272_));
						_tmp274_ = _tmp273_;
						_tmp275_ = ns_name;
