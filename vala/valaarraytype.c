...
static gchar* vala_array_type_real_to_qualified_string (ValaDataType* base, ValaScope* scope) {
	...
	_tmp4_ = _tmp3_;
	_tmp5_ = scope;
	_tmp6_ = vala_data_type_to_qualified_string (_tmp4_, _tmp5_);
	_tmp7_ = _tmp6_;
	_tmp8_ = self->priv->_rank;
	_tmp9_ = g_strnfill ((gsize) (_tmp8_ - 1), ',');
	_tmp10_ = _tmp9_;
	_tmp11_ = _tmp0_;
	_tmp12_ = g_strdup_printf ("%s[%s]%s", _tmp7_, _tmp10_, _tmp11_);
	_tmp13_ = _tmp12_;
	_g_free0 (_tmp10_);
	_g_free0 (_tmp7_);
	result = _tmp13_;
...
static gboolean vala_array_type_real_compatible (ValaDataType* base, ValaDataType* target_type) {
	...
	if (_tmp9_) {
		...
		_tmp19_ = vala_data_type_get_data_type ((ValaDataType*) _tmp18_);
		_tmp20_ = _tmp19_;
		_tmp21_ = vala_typesymbol_is_subtype_of (_tmp13_, _tmp20_);
		_tmp22_ = _tmp21_;
		...
		if (_tmp22_) {
			...
			ValaSymbol* _tmp34_;
			_tmp23_ = vala_array_type_get_element_type (self);
			_tmp24_ = _tmp23_;
			...
			_tmp32_ = _tmp31_;
			_tmp33_ = vala_scope_lookup (_tmp32_, "string");
			_tmp34_ = _tmp33_;
			_tmp10_ = VALA_SYMBOL (_tmp26_) == _tmp34_;
		...
		_tmp42_ = _tmp41_;
		_tmp43_ = _tmp42_->gvariant_type;
		_tmp44_ = vala_data_type_get_data_type ((ValaDataType*) _tmp43_);
		_tmp45_ = _tmp44_;
		_tmp46_ = vala_typesymbol_is_subtype_of (_tmp38_, _tmp45_);
		_tmp47_ = _tmp46_;
	...
	if (VALA_IS_POINTER_TYPE (_tmp49_)) {
		...
		if (_tmp53_ != NULL) {
			...
			_tmp56_ = _tmp55_;
			_tmp57_ = vala_code_node_get_attribute ((ValaCodeNode*) _tmp56_, "PointerType");
			_tmp58_ = _tmp57_;
	...
	_tmp61_ = target_type;
	_tmp62_ = vala_data_type_get_type_parameter (_tmp61_);
	_tmp63_ = _tmp62_;
	if (_tmp63_ != NULL) {
		result = TRUE;
		return result;
	...
	_tmp64_ = target_type;
	_tmp65_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp64_) ? ((ValaArrayType*) _tmp64_) : NULL);
	target_array_type = _tmp65_;
...
static ValaDataType* vala_array_type_real_get_actual_type (ValaDataType* base, ValaDataType* derived_instance_type, ValaMemberAccess* method_access, ValaCodeNode* node_reference) {
	...
	_tmp8_ = _tmp7_;
	if (VALA_IS_GENERIC_TYPE (_tmp8_)) {
		_tmp6_ = TRUE;
	} else {
		ValaDataType* _tmp9_;
	...
	if (_tmp12_) {
		...
		_result_ = VALA_ARRAY_TYPE (_tmp14_);
		_tmp15_ = _result_;
		_tmp16_ = _result_;
...
static gboolean vala_array_type_real_is_disposable (ValaDataType* base) {
	...
	if (_tmp0_) {
		...
		_tmp7_ = _tmp6_;
		_tmp8_ = _tmp7_ == VALA_PROFILE_DOVA;
		...
		if (_tmp8_) {
			...
			_tmp9_ = VALA_DATA_TYPE_CLASS (vala_array_type_parent_class)->is_disposable ((ValaDataType*) VALA_REFERENCE_TYPE (self));
			result = _tmp9_;
			return result;
		}
	}
