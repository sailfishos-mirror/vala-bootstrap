...
static inline void vala_parser_prev (ValaParser* self) {
	...
	self->priv->size = _tmp1_ + 1;
	_tmp2_ = self->priv->size;
	g_assert (_tmp2_ <= VALA_PARSER_BUFFER_SIZE);
}
...
static ValaSourceReference* vala_parser_get_src (ValaParser* self, ValaSourceLocation* begin) {
	...
	_tmp13_ = _tmp12_[last_index];
	_tmp14_ = _tmp13_.end;
	_tmp15_ = _tmp14_.column;
	_tmp16_ = vala_source_reference_new (_tmp3_, _tmp5_, _tmp7_, _tmp11_, _tmp15_);
	result = _tmp16_;
	return result;
}
...
static ValaSourceReference* vala_parser_get_current_src (ValaParser* self) {
	...
	_tmp23_ = vala_source_reference_new (_tmp2_, _tmp7_, _tmp12_, _tmp17_, _tmp22_);
	result = _tmp23_;
	return result;
}
...
static ValaSourceReference* vala_parser_get_last_src (ValaParser* self) {
	...
	_tmp16_ = self->priv->tokens;
	_tmp16__length1 = self->priv->tokens_length1;
	_tmp17_ = _tmp16_[last_index];
	_tmp18_ = _tmp17_.end;
	_tmp19_ = _tmp18_.column;
	_tmp20_ = vala_source_reference_new (_tmp3_, _tmp7_, _tmp11_, _tmp15_, _tmp19_);
	result = _tmp20_;
	return result;
}
...
static ValaDataType* vala_parser_parse_type (ValaParser* self, gboolean owned_by_default, gboolean can_weak_ref, GError** error) {
	...
	if (_tmp3_) {
		...
		if (_tmp6_ == VALA_PROFILE_DOVA) {
			...
			if (_tmp8_) {
				...
				_tmp9_ = vala_parser_accept (self, VALA_TOKEN_TYPE_WEAK);
				_tmp7_ = _tmp9_;
			} else {
				_tmp7_ = FALSE;
			}
			...
			_tmp11_ = vala_parser_accept (self, VALA_TOKEN_TYPE_UNOWNED);
			if (_tmp11_) {
				value_owned = FALSE;
			} else {
				...
				if (_tmp12_) {
					...
					gboolean _tmp14_;
					gboolean _tmp18_;
					_tmp14_ = can_weak_ref;
					if (!_tmp14_) {
						ValaCodeContext* _tmp15_;
						gboolean _tmp16_;
						gboolean _tmp17_;
						_tmp15_ = self->priv->context;
						_tmp16_ = vala_code_context_get_deprecated (_tmp15_);
						_tmp17_ = _tmp16_;
						_tmp13_ = !_tmp17_;
					} else {
						_tmp13_ = FALSE;
					...
					if (_tmp18_) {
						...
						ValaSourceReference* _tmp20_;
						_tmp19_ = vala_parser_get_last_src (self);
						_tmp20_ = _tmp19_;
						vala_report_warning (_tmp20_, "deprecated syntax, use `unowned` modifier");
		...
		_tmp23_ = vala_code_context_get_profile (_tmp22_);
		_tmp24_ = _tmp23_;
		if (_tmp24_ != VALA_PROFILE_DOVA) {
			gboolean _tmp25_ = FALSE;
			_tmp25_ = vala_parser_accept (self, VALA_TOKEN_TYPE_OWNED);
			_tmp21_ = _tmp25_;
		} else {
			_tmp21_ = FALSE;
		}
	...
	if (_tmp32_) {
		...
		_tmp33_ = vala_parser_accept (self, VALA_TOKEN_TYPE_VOID);
		_tmp27_ = _tmp33_;
	} else {
		_tmp27_ = FALSE;
	}
	...
	if (_tmp34_) {
		...
		ValaList* _tmp46_;
		_tmp39_ = vala_parser_parse_symbol_name (self, &_inner_error_);
		sym = _tmp39_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp40_ = vala_parser_parse_type_argument_list (self, FALSE, &_inner_error_);
		type_arg_list = _tmp40_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
				_vala_code_node_unref0 (sym);
		...
		_tmp41_ = sym;
		_tmp42_ = begin;
		_tmp43_ = vala_parser_get_src (self, &_tmp42_);
		_tmp44_ = _tmp43_;
		_tmp45_ = vala_unresolved_type_new_from_symbol (_tmp41_, _tmp44_);
		_vala_code_node_unref0 (type);
		...
		if (_tmp46_ != NULL) {
			{
				...
				while (TRUE) {
					...
					_type_arg_index = _tmp52_ + 1;
					_tmp53_ = _type_arg_index;
					_tmp54_ = _type_arg_size;
					if (!(_tmp53_ < _tmp54_)) {
						break;
					}
					_tmp55_ = _type_arg_list;
	...
	while (TRUE) {
		...
		_tmp60_ = vala_parser_accept (self, VALA_TOKEN_TYPE_STAR);
		if (!_tmp60_) {
			break;
		}
		_tmp61_ = type;
		...
		_tmp64_ = _tmp63_;
		_tmp65_ = vala_pointer_type_new (_tmp61_, _tmp64_);
		_vala_code_node_unref0 (type);
		type = (ValaDataType*) _tmp65_;
		_vala_source_reference_unref0 (_tmp64_);
	}
	_tmp66_ = type;
	if (!VALA_IS_POINTER_TYPE (_tmp66_)) {
		ValaDataType* _tmp67_;
		gboolean _tmp68_ = FALSE;
		_tmp67_ = type;
		_tmp68_ = vala_parser_accept (self, VALA_TOKEN_TYPE_INTERR);
		vala_data_type_set_nullable (_tmp67_, _tmp68_);
	}
	while (TRUE) {
		...
		_tmp69_ = vala_parser_accept (self, VALA_TOKEN_TYPE_OPEN_BRACKET);
		if (!_tmp69_) {
			break;
		}
		invalid_array = FALSE;
		array_rank = 0;
		{
			...
			while (TRUE) {
				...
				_tmp70_ = FALSE;
				_tmp78_ = array_rank;
				array_rank = _tmp78_ + 1;
				_tmp80_ = vala_parser_current (self);
				if (_tmp80_ != VALA_TOKEN_TYPE_COMMA) {
					ValaTokenType _tmp81_ = 0;
					_tmp81_ = vala_parser_current (self);
					_tmp79_ = _tmp81_ != VALA_TOKEN_TYPE_CLOSE_BRACKET;
				} else {
					_tmp79_ = FALSE;
				}
				_tmp82_ = _tmp79_;
				if (_tmp82_) {
					...
					_tmp83_ = vala_parser_parse_expression (self, &_inner_error_);
					_tmp84_ = _tmp83_;
		...
		_tmp85_ = type;
		vala_data_type_set_value_owned (_tmp85_, TRUE);
		_tmp86_ = type;
		_tmp87_ = array_rank;
		_tmp88_ = begin;
		_tmp89_ = vala_parser_get_src (self, &_tmp88_);
		_tmp90_ = _tmp89_;
		_tmp91_ = vala_array_type_new (_tmp86_, _tmp87_, _tmp90_);
		_tmp92_ = _tmp91_;
		_vala_source_reference_unref0 (_tmp90_);
		array_type = _tmp92_;
		_tmp93_ = array_type;
		_tmp94_ = vala_parser_accept (self, VALA_TOKEN_TYPE_INTERR);
		vala_data_type_set_nullable ((ValaDataType*) _tmp93_, _tmp94_);
		_tmp95_ = array_type;
		_tmp96_ = invalid_array;
		vala_array_type_set_invalid_syntax (_tmp95_, _tmp96_);
		_tmp97_ = array_type;
		_tmp98_ = _vala_code_node_ref0 ((ValaDataType*) _tmp97_);
		_vala_code_node_unref0 (type);
		type = _tmp98_;
		_vala_code_node_unref0 (array_type);
	}
	_tmp99_ = vala_parser_accept (self, VALA_TOKEN_TYPE_OP_NEG);
	if (_tmp99_) {
		ValaSourceReference* _tmp100_ = NULL;
		ValaSourceReference* _tmp101_;
		_tmp100_ = vala_parser_get_last_src (self);
		_tmp101_ = _tmp100_;
		vala_report_warning (_tmp101_, "obsolete syntax, types are non-null by default");
		_vala_source_reference_unref0 (_tmp101_);
	}
	_tmp102_ = owned_by_default;
	if (!_tmp102_) {
		...
		_tmp106_ = _tmp105_;
		if (_tmp106_ != VALA_PROFILE_DOVA) {
			gboolean _tmp107_ = FALSE;
			_tmp107_ = vala_parser_accept (self, VALA_TOKEN_TYPE_HASH);
			_tmp103_ = _tmp107_;
		} else {
			_tmp103_ = FALSE;
		}
		...
		if (_tmp108_) {
			...
			_tmp110_ = vala_code_context_get_deprecated (_tmp109_);
			_tmp111_ = _tmp110_;
			if (!_tmp111_) {
				ValaSourceReference* _tmp112_ = NULL;
				ValaSourceReference* _tmp113_;
				_tmp112_ = vala_parser_get_last_src (self);
				_tmp113_ = _tmp112_;
				vala_report_warning (_tmp113_, "deprecated syntax, use `owned` modifier");
	...
	_tmp114_ = type;
	if (VALA_IS_POINTER_TYPE (_tmp114_)) {
		value_owned = FALSE;
	}
	_tmp115_ = type;
	_tmp116_ = is_dynamic;
	vala_data_type_set_is_dynamic (_tmp115_, _tmp116_);
	_tmp117_ = type;
	_tmp118_ = value_owned;
	vala_data_type_set_value_owned (_tmp117_, _tmp118_);
	result = type;
	return result;
}
...
static ValaDataType* vala_parser_parse_inline_array_type (ValaParser* self, ValaDataType* type, GError** error) {
	...
	if (_tmp4_) {
		...
		if (_tmp5_ != VALA_TOKEN_TYPE_CLOSE_BRACKET) {
			...
			length_literal = VALA_INTEGER_LITERAL (_tmp12_);
...
static ValaExpression* vala_parser_parse_argument (ValaParser* self, GError** error) {
	...
	if (_tmp1_) {
		...
		if (_tmp9_) {
			...
			_tmp18_ = expr;
			_tmp19_ = _vala_code_node_ref0 (VALA_IS_MEMBER_ACCESS (_tmp18_) ? ((ValaMemberAccess*) _tmp18_) : NULL);
			ma = _tmp19_;
			_tmp22_ = ma;
			if (_tmp22_ != NULL) {
	...
	switch (_tmp1_) {
		...
		case VALA_TOKEN_TYPE_OPEN_BRACE:
		{
			...
			if (_tmp6_ == VALA_PROFILE_DOVA) {
				...
				ValaInitializerList* _tmp9_ = NULL;
				ValaInitializerList* _tmp10_;
				_tmp9_ = vala_parser_parse_initializer (self, &_inner_error_);
				_tmp10_ = _tmp9_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
		...
		case VALA_TOKEN_TYPE_OPEN_BRACKET:
		{
			...
			if (_tmp13_ == VALA_PROFILE_DOVA) {
				...
				_tmp16_ = vala_parser_parse_simple_name (self, &_inner_error_);
				_tmp17_ = _tmp16_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
		...
		case VALA_TOKEN_TYPE_OPEN_PARENS:
		{
			...
			_tmp18_ = vala_parser_parse_tuple (self, &_inner_error_);
			_tmp19_ = _tmp18_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_TOKEN_TYPE_OPEN_TEMPLATE:
		{
			...
			_tmp20_ = vala_parser_parse_template (self, &_inner_error_);
			_tmp21_ = _tmp20_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_TOKEN_TYPE_OPEN_REGEX_LITERAL:
		{
			...
			_tmp22_ = vala_parser_parse_regex_literal (self, &_inner_error_);
			_tmp23_ = _tmp22_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_TOKEN_TYPE_THIS:
		{
			...
			ValaExpression* _tmp25_;
			_tmp24_ = vala_parser_parse_this_access (self, &_inner_error_);
			_tmp25_ = _tmp24_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_TOKEN_TYPE_BASE:
		{
			...
			_tmp26_ = vala_parser_parse_base_access (self, &_inner_error_);
			_tmp27_ = _tmp26_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_TOKEN_TYPE_NEW:
		{
			...
			_tmp28_ = vala_parser_parse_object_or_array_creation_expression (self, &_inner_error_);
			_tmp29_ = _tmp28_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_TOKEN_TYPE_TYPEOF:
		{
			...
			_tmp34_ = vala_parser_parse_typeof_expression (self, &_inner_error_);
			_tmp35_ = _tmp34_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		default:
		{
			...
			_tmp36_ = vala_parser_parse_simple_name (self, &_inner_error_);
			_tmp37_ = _tmp36_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
	...
	while (TRUE) {
		...
		switch (_tmp39_) {
			case VALA_TOKEN_TYPE_DOT:
			{
				...
				_tmp40_ = begin;
				_tmp41_ = expr;
				_tmp42_ = vala_parser_parse_member_access (self, &_tmp40_, _tmp41_, &_inner_error_);
				_tmp43_ = _tmp42_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
			...
			case VALA_TOKEN_TYPE_OPEN_PARENS:
			{
				...
				_tmp51_ = begin;
				_tmp52_ = expr;
				_tmp53_ = vala_parser_parse_method_call (self, &_tmp51_, _tmp52_, &_inner_error_);
				_tmp54_ = _tmp53_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
			...
			case VALA_TOKEN_TYPE_OPEN_BRACKET:
			{
				...
				_tmp55_ = begin;
				_tmp56_ = expr;
				_tmp57_ = vala_parser_parse_element_access (self, &_tmp55_, _tmp56_, &_inner_error_);
				_tmp58_ = _tmp57_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
			...
			case VALA_TOKEN_TYPE_OPEN_BRACE:
			{
				...
				gboolean _tmp66_;
				_tmp59_ = expr;
				_tmp60_ = _vala_code_node_ref0 (VALA_IS_MEMBER_ACCESS (_tmp59_) ? ((ValaMemberAccess*) _tmp59_) : NULL);
				ma = _tmp60_;
				_tmp62_ = self->priv->context;
				_tmp63_ = vala_code_context_get_profile (_tmp62_);
				_tmp64_ = _tmp63_;
				if (_tmp64_ == VALA_PROFILE_DOVA) {
				...
				if (_tmp66_) {
					...
					_tmp67_ = begin;
					_tmp68_ = ma;
					_tmp69_ = vala_parser_parse_object_literal (self, &_tmp67_, _tmp68_, &_inner_error_);
					_tmp70_ = _tmp69_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
			...
			case VALA_TOKEN_TYPE_OP_INC:
			{
				...
				_tmp71_ = begin;
				_tmp72_ = expr;
				_tmp73_ = vala_parser_parse_post_increment_expression (self, &_tmp71_, _tmp72_, &_inner_error_);
				_tmp74_ = _tmp73_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
			...
			case VALA_TOKEN_TYPE_OP_DEC:
			{
				...
				_tmp75_ = begin;
				_tmp76_ = expr;
				_tmp77_ = vala_parser_parse_post_decrement_expression (self, &_tmp75_, _tmp76_, &_inner_error_);
				_tmp78_ = _tmp77_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
...
static ValaExpression* vala_parser_parse_method_call (ValaParser* self, ValaSourceLocation* begin, ValaExpression* inner, GError** error) {
	...
	if (_tmp5_ > 0) {
		ValaExpression* _tmp6_;
		_tmp6_ = inner;
		_tmp2_ = VALA_IS_MEMBER_ACCESS (_tmp6_);
	} else {
		_tmp2_ = FALSE;
	}
	_tmp7_ = _tmp2_;
...
static ValaExpression* vala_parser_parse_object_literal (ValaParser* self, ValaSourceLocation* begin, ValaMemberAccess* member, GError** error) {
	...
	_tmp3_ = vala_parser_get_src (self, &_tmp2_);
	_tmp4_ = _tmp3_;
	_tmp5_ = vala_object_creation_expression_new (_tmp1_, _tmp4_);
	_tmp6_ = _tmp5_;
	_vala_source_reference_unref0 (_tmp4_);
	expr = _tmp6_;
	...
	}
	{
		...
		while (TRUE) {
			...
			member_begin = _tmp10_;
			_tmp11_ = vala_parser_parse_identifier (self, &_inner_error_);
			id = _tmp11_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
			...
			_tmp12_ = vala_parser_parse_expression (self, &_inner_error_);
			member_expr = _tmp12_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
			...
			_tmp14_ = id;
			_tmp15_ = member_expr;
			_tmp16_ = member_begin;
			_tmp17_ = vala_parser_get_src (self, &_tmp16_);
			_tmp18_ = _tmp17_;
			_tmp19_ = vala_member_initializer_new (_tmp14_, _tmp15_, _tmp18_);
			_tmp20_ = _tmp19_;
			vala_object_creation_expression_add_member_initializer (_tmp13_, _tmp20_);
...
static ValaList* vala_parser_parse_object_initializer (ValaParser* self, GError** error) {
	...
	if (_tmp5_ != VALA_PROFILE_DOVA) {
		gboolean _tmp6_ = FALSE;
		_tmp6_ = vala_parser_accept (self, VALA_TOKEN_TYPE_OPEN_BRACE);
		_tmp2_ = _tmp6_;
	} else {
		_tmp2_ = FALSE;
	}
	...
	if (_tmp7_) {
		{
			...
			while (TRUE) {
				...
				ValaMemberInitializer* _tmp12_;
				ValaArrayList* _tmp13_;
				ValaMemberInitializer* _tmp14_;
				_tmp9_ = _tmp8_;
				if (!_tmp9_) {
					gboolean _tmp10_ = FALSE;
				...
				_tmp8_ = FALSE;
				_tmp11_ = vala_parser_parse_member_initializer (self, &_inner_error_);
				_tmp12_ = _tmp11_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
...
static ValaExpression* vala_parser_parse_yield_expression (ValaParser* self, GError** error) {
	...
	if (_tmp3_ == NULL) {
		...
		_tmp6_ = _tmp5_;
		vala_report_error (_tmp6_, "syntax error, expected method call");
		_tmp7_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, "expected method call");
	...
	_tmp8_ = call;
	vala_method_call_set_is_yield_expression (_tmp8_, TRUE);
		...
		switch (_tmp5_) {
			...
			case VALA_BINARY_OPERATOR_GREATER_THAN_OR_EQUAL:
			{
				...
				if (!_tmp14_) {
					...
					gboolean _tmp20_;
					_tmp15_ = left;
					_tmp16_ = _vala_code_node_ref0 (VALA_BINARY_EXPRESSION (_tmp15_));
					be = _tmp16_;
					_tmp17_ = be;
			...
			case VALA_BINARY_OPERATOR_GREATER_THAN:
			{
				...
				if (_tmp27_) {
					...
					if (!_tmp36_) {
						...
						gboolean _tmp42_;
						_tmp37_ = left;
						_tmp38_ = _vala_code_node_ref0 (VALA_BINARY_EXPRESSION (_tmp37_));
						be = _tmp38_;
						_tmp39_ = be;
	...
	while (TRUE) {
		...
		}
		{
			...
			if (!_tmp54_) {
				...
				_tmp58_ = _tmp57_;
				if (_tmp58_ == VALA_PROFILE_DOVA) {
					ValaStatement* _tmp59_;
					_tmp59_ = stmt;
					_tmp55_ = VALA_IS_RETURN_STATEMENT (_tmp59_);
				} else {
					_tmp55_ = FALSE;
				}
				_tmp60_ = _tmp55_;
				if (_tmp60_) {
					...
					ValaExpression* _tmp65_;
					_tmp61_ = stmt;
					_tmp62_ = _vala_code_node_ref0 (VALA_RETURN_STATEMENT (_tmp61_));
					ret_stmt = _tmp62_;
					_tmp63_ = ret_stmt;
					_tmp64_ = vala_return_statement_get_return_expression (_tmp63_);
					_tmp65_ = _tmp64_;
					if (_tmp65_ != NULL) {
						...
						ValaReturnStatement* _tmp79_;
						ValaBlock* _tmp80_;
						ValaAssignment* _tmp81_;
						ValaStatement* _tmp82_;
						...
						_tmp68_ = _tmp67_;
						_tmp69_ = vala_member_access_new_simple ("result", _tmp68_);
						_tmp70_ = _tmp69_;
						_tmp71_ = ret_stmt;
						_tmp72_ = vala_return_statement_get_return_expression (_tmp71_);
						_tmp73_ = _tmp72_;
						_tmp74_ = stmt;
						_tmp75_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp74_);
						_tmp76_ = _tmp75_;
						_tmp77_ = vala_assignment_new ((ValaExpression*) _tmp70_, _tmp73_, VALA_ASSIGNMENT_OPERATOR_SIMPLE, _tmp76_);
						_tmp78_ = _tmp77_;
						_vala_code_node_unref0 (_tmp70_);
						assignment = _tmp78_;
						_tmp79_ = ret_stmt;
						vala_return_statement_set_return_expression (_tmp79_, NULL);
						_tmp80_ = block;
						_tmp81_ = assignment;
						_tmp82_ = stmt;
						_tmp83_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp82_);
						_tmp84_ = _tmp83_;
						_tmp85_ = vala_expression_statement_new ((ValaExpression*) _tmp81_, _tmp84_);
						_tmp86_ = _tmp85_;
						vala_block_add_statement (_tmp80_, (ValaStatement*) _tmp86_);
				...
				_tmp87_ = block;
				_tmp88_ = stmt;
				vala_block_add_statement (_tmp87_, _tmp88_);
			}
			_vala_code_node_unref0 (stmt);
		}
		goto __finally11;
		...
		{
			GError* e = NULL;
			ValaParserRecoveryState _tmp89_ = 0;
			e = _inner_error_;
			_inner_error_ = NULL;
			_tmp89_ = vala_parser_recover (self);
			if (_tmp89_ != VALA_PARSER_RECOVERY_STATE_STATEMENT_BEGIN) {
				_g_error_free0 (e);
				break;
			}
			_g_error_free0 (e);
...
static ValaBlock* vala_parser_parse_embedded_statement (ValaParser* self, GError** error) {
	...
	if (_tmp13_ == VALA_PROFILE_DOVA) {
		...
		_tmp14_ = stmt;
		_tmp10_ = VALA_IS_RETURN_STATEMENT (_tmp14_);
	} else {
		_tmp10_ = FALSE;
	}
	_tmp15_ = _tmp10_;
	if (_tmp15_) {
		ValaStatement* _tmp16_;
		ValaReturnStatement* _tmp17_;
		ValaReturnStatement* ret_stmt;
		ValaReturnStatement* _tmp18_;
		ValaExpression* _tmp19_;
		ValaExpression* _tmp20_;
		_tmp16_ = stmt;
		_tmp17_ = _vala_code_node_ref0 (VALA_RETURN_STATEMENT (_tmp16_));
		ret_stmt = _tmp17_;
		_tmp18_ = ret_stmt;
		_tmp19_ = vala_return_statement_get_return_expression (_tmp18_);
		_tmp20_ = _tmp19_;
		if (_tmp20_ != NULL) {
			ValaMemberAccess* _tmp21_;
			ValaMemberAccess* _tmp22_;
			ValaReturnStatement* _tmp23_;
			ValaExpression* _tmp24_;
			ValaExpression* _tmp25_;
			ValaAssignment* _tmp26_;
			ValaAssignment* _tmp27_;
			ValaAssignment* assignment;
			ValaReturnStatement* _tmp28_;
			ValaBlock* _tmp29_;
			ValaAssignment* _tmp30_;
			ValaExpressionStatement* _tmp31_;
			ValaExpressionStatement* _tmp32_;
			_tmp21_ = vala_member_access_new_simple ("result", NULL);
			_tmp22_ = _tmp21_;
			_tmp23_ = ret_stmt;
			_tmp24_ = vala_return_statement_get_return_expression (_tmp23_);
			_tmp25_ = _tmp24_;
			_tmp26_ = vala_assignment_new ((ValaExpression*) _tmp22_, _tmp25_, VALA_ASSIGNMENT_OPERATOR_SIMPLE, NULL);
			_tmp27_ = _tmp26_;
			_vala_code_node_unref0 (_tmp22_);
			assignment = _tmp27_;
			_tmp28_ = ret_stmt;
			vala_return_statement_set_return_expression (_tmp28_, NULL);
			_tmp29_ = block;
			_tmp30_ = assignment;
			_tmp31_ = vala_expression_statement_new ((ValaExpression*) _tmp30_, NULL);
			_tmp32_ = _tmp31_;
			vala_block_add_statement (_tmp29_, (ValaStatement*) _tmp32_);
			_vala_code_node_unref0 (_tmp32_);
			_vala_code_node_unref0 (assignment);
		}
		_vala_code_node_unref0 (ret_stmt);
	...
	_tmp33_ = block;
	_tmp34_ = stmt;
	vala_block_add_statement (_tmp33_, _tmp34_);
	result = block;
	_vala_code_node_unref0 (stmt);
	return result;
}
...
static ValaBlock* vala_parser_parse_block (ValaParser* self, GError** error) {
	...
	_tmp18_ = _tmp17_;
	_tmp19_ = vala_source_reference_get_last_line (_tmp18_);
	_tmp20_ = _tmp19_;
	vala_source_reference_set_last_line (_tmp16_, _tmp20_);
	_vala_source_reference_unref0 (_tmp18_);
	_tmp21_ = block;
	_tmp22_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp21_);
	_tmp23_ = _tmp22_;
	_tmp24_ = vala_parser_get_current_src (self);
	_tmp25_ = _tmp24_;
	_tmp26_ = vala_source_reference_get_last_column (_tmp25_);
	_tmp27_ = _tmp26_;
	vala_source_reference_set_last_column (_tmp23_, _tmp27_);
	...
	if (_tmp0_ != NULL) {
		{
			...
			gint _attr_index;
			_tmp1_ = attributes;
			_tmp2_ = _vala_iterable_ref0 (VALA_LIST (_tmp1_));
			_attr_list = _tmp2_;
			_tmp3_ = _attr_list;
			_tmp4_ = vala_collection_get_size ((ValaCollection*) _tmp3_);
			_tmp5_ = _tmp4_;
...
static void vala_parser_parse_main_block (ValaParser* self, ValaSymbol* parent, GError** error) {
	...
	_tmp23_ = _tmp22_;
	_tmp24_ = vala_source_reference_get_last_line (_tmp23_);
	_tmp25_ = _tmp24_;
	vala_source_reference_set_last_line (_tmp21_, _tmp25_);
	_vala_source_reference_unref0 (_tmp23_);
	_tmp26_ = vala_subroutine_get_body ((ValaSubroutine*) method);
	_tmp27_ = _tmp26_;
	_tmp28_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp27_);
	_tmp29_ = _tmp28_;
	_tmp30_ = vala_parser_get_current_src (self);
	_tmp31_ = _tmp30_;
	_tmp32_ = vala_source_reference_get_last_column (_tmp31_);
	_tmp33_ = _tmp32_;
	vala_source_reference_set_last_column (_tmp29_, _tmp33_);
	_vala_source_reference_unref0 (_tmp31_);
	_tmp35_ = self->priv->context;
	_tmp36_ = vala_code_context_get_experimental (_tmp35_);
	_tmp37_ = _tmp36_;
	if (!_tmp37_) {
		...
		_tmp40_ = _tmp39_;
		_tmp34_ = _tmp40_ != VALA_PROFILE_DOVA;
	} else {
		_tmp34_ = FALSE;
	}
	_tmp41_ = _tmp34_;
	if (_tmp41_) {
		...
		_tmp43_ = _tmp42_;
		vala_report_warning (_tmp43_, "main blocks are experimental");
	}
	_tmp44_ = parent;
	vala_symbol_add_method (_tmp44_, method);
	_vala_code_node_unref0 (method);
}
...
static void vala_parser_parse_declaration (ValaParser* self, ValaSymbol* parent, gboolean root, GError** error) {
	...
	switch (_tmp8_) {
		case VALA_TOKEN_TYPE_CONSTRUCT:
		{
			...
			if (_tmp11_ == VALA_PROFILE_GOBJECT) {
				...
				_tmp13_ = parent;
				_tmp14_ = attrs;
				vala_parser_parse_constructor_declaration (self, _tmp13_, _tmp14_, &_inner_error_);
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
						_vala_iterable_unref0 (attrs);
		...
		case VALA_TOKEN_TYPE_TILDE:
		{
			...
			_tmp16_ = parent;
			_tmp17_ = attrs;
			vala_parser_parse_destructor_declaration (self, _tmp16_, _tmp17_, &_inner_error_);
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
					_vala_iterable_unref0 (attrs);
		...
		case VALA_TOKEN_TYPE_NEW:
		{
			...
			if (_tmp18_ != NULL) {
				...
				GError* _tmp21_;
				GError* _tmp22_;
				_tmp19_ = vala_parser_get_error (self, "expected statement");
				_tmp20_ = _tmp19_;
				_tmp21_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, _tmp20_);
				_tmp22_ = _tmp21_;
				_g_free0 (_tmp20_);
			...
			if (!_tmp23_) {
				...
				GError* _tmp26_;
				GError* _tmp27_;
				_tmp24_ = vala_parser_get_error (self, "statements outside blocks allowed only in root namespace");
				_tmp25_ = _tmp24_;
				_tmp26_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, _tmp25_);
				_tmp27_ = _tmp26_;
				_g_free0 (_tmp25_);
			...
			_tmp29_ = parent;
			vala_parser_parse_main_block (self, _tmp29_, &_inner_error_);
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
					_vala_iterable_unref0 (attrs);
		...
		default:
		{
			...
			if (_tmp30_) {
				...
				gboolean is_expr;
				gboolean _tmp32_;
				_tmp31_ = vala_parser_is_expression (self, &_inner_error_);
				is_expr = _tmp31_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
				...
				if (_tmp32_) {
					...
					_tmp34_ = parent;
					vala_parser_parse_main_block (self, _tmp34_, &_inner_error_);
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
							_vala_iterable_unref0 (attrs);
			...
			switch (_tmp35_) {
				...
				case VALA_TOKEN_TYPE_COLON:
				{
					...
					switch (_tmp37_) {
						case VALA_TOKEN_TYPE_CLASS:
						{
							...
							_tmp38_ = parent;
							_tmp39_ = attrs;
							vala_parser_parse_class_declaration (self, _tmp38_, _tmp39_, &_inner_error_);
							if (_inner_error_ != NULL) {
								if (_inner_error_->domain == VALA_PARSE_ERROR) {
									g_propagate_error (error, _inner_error_);
									_vala_iterable_unref0 (attrs);
						...
						case VALA_TOKEN_TYPE_ENUM:
						{
							...
							_tmp40_ = parent;
							_tmp41_ = attrs;
							vala_parser_parse_enum_declaration (self, _tmp40_, _tmp41_, &_inner_error_);
							if (_inner_error_ != NULL) {
								if (_inner_error_->domain == VALA_PARSE_ERROR) {
									g_propagate_error (error, _inner_error_);
									_vala_iterable_unref0 (attrs);
						...
						case VALA_TOKEN_TYPE_ERRORDOMAIN:
						{
							...
							_tmp42_ = parent;
							_tmp43_ = attrs;
							vala_parser_parse_errordomain_declaration (self, _tmp42_, _tmp43_, &_inner_error_);
							if (_inner_error_ != NULL) {
								if (_inner_error_->domain == VALA_PARSE_ERROR) {
									g_propagate_error (error, _inner_error_);
									_vala_iterable_unref0 (attrs);
						...
						case VALA_TOKEN_TYPE_INTERFACE:
						{
							...
							_tmp44_ = parent;
							_tmp45_ = attrs;
							vala_parser_parse_interface_declaration (self, _tmp44_, _tmp45_, &_inner_error_);
							if (_inner_error_ != NULL) {
								if (_inner_error_->domain == VALA_PARSE_ERROR) {
									g_propagate_error (error, _inner_error_);
									_vala_iterable_unref0 (attrs);
						...
						case VALA_TOKEN_TYPE_NAMESPACE:
						{
							...
							_tmp46_ = parent;
							_tmp47_ = attrs;
							vala_parser_parse_namespace_declaration (self, _tmp46_, _tmp47_, &_inner_error_);
							if (_inner_error_ != NULL) {
								if (_inner_error_->domain == VALA_PARSE_ERROR) {
									g_propagate_error (error, _inner_error_);
									_vala_iterable_unref0 (attrs);
						...
						case VALA_TOKEN_TYPE_STRUCT:
						{
							...
							_tmp48_ = parent;
							_tmp49_ = attrs;
							vala_parser_parse_struct_declaration (self, _tmp48_, _tmp49_, &_inner_error_);
							if (_inner_error_ != NULL) {
								if (_inner_error_->domain == VALA_PARSE_ERROR) {
									g_propagate_error (error, _inner_error_);
									_vala_iterable_unref0 (attrs);
				...
				case VALA_TOKEN_TYPE_OPEN_PARENS:
				{
					...
					ValaList* _tmp52_;
					_tmp50_ = begin;
					vala_parser_rollback (self, &_tmp50_);
					_tmp51_ = parent;
					_tmp52_ = attrs;
					vala_parser_parse_creation_method_declaration (self, _tmp51_, _tmp52_, &_inner_error_);
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
							_vala_iterable_unref0 (attrs);
				...
				default:
				{
					...
					switch (_tmp53_) {
						case VALA_TOKEN_TYPE_OPEN_PARENS:
						{
							...
							ValaTokenType _tmp55_;
							_tmp54_ = begin;
							vala_parser_rollback (self, &_tmp54_);
							_tmp55_ = last_keyword;
							switch (_tmp55_) {
								case VALA_TOKEN_TYPE_DELEGATE:
								{
									ValaSymbol* _tmp56_;
									...
									_tmp56_ = parent;
									_tmp57_ = attrs;
									vala_parser_parse_delegate_declaration (self, _tmp56_, _tmp57_, &_inner_error_);
									if (_inner_error_ != NULL) {
										if (_inner_error_->domain == VALA_PARSE_ERROR) {
											g_propagate_error (error, _inner_error_);
											_vala_iterable_unref0 (attrs);
								...
								case VALA_TOKEN_TYPE_SIGNAL:
								{
									...
									_tmp58_ = parent;
									_tmp59_ = attrs;
									vala_parser_parse_signal_declaration (self, _tmp58_, _tmp59_, &_inner_error_);
									if (_inner_error_ != NULL) {
										if (_inner_error_->domain == VALA_PARSE_ERROR) {
											g_propagate_error (error, _inner_error_);
											_vala_iterable_unref0 (attrs);
								...
								default:
								{
									...
									_tmp60_ = parent;
									_tmp61_ = attrs;
									vala_parser_parse_method_declaration (self, _tmp60_, _tmp61_, &_inner_error_);
									if (_inner_error_ != NULL) {
										if (_inner_error_->domain == VALA_PARSE_ERROR) {
											g_propagate_error (error, _inner_error_);
											_vala_iterable_unref0 (attrs);
						...
						{
							ValaSourceLocation _tmp62_;
							ValaTokenType _tmp63_;
							_tmp62_ = begin;
							vala_parser_rollback (self, &_tmp62_);
							_tmp63_ = last_keyword;
							switch (_tmp63_) {
								case VALA_TOKEN_TYPE_CONST:
								{
									ValaSymbol* _tmp64_;
									...
									_tmp64_ = parent;
									_tmp65_ = attrs;
									vala_parser_parse_constant_declaration (self, _tmp64_, _tmp65_, &_inner_error_);
									if (_inner_error_ != NULL) {
										if (_inner_error_->domain == VALA_PARSE_ERROR) {
											g_propagate_error (error, _inner_error_);
											_vala_iterable_unref0 (attrs);
								...
								default:
								{
									...
									_tmp66_ = parent;
									_tmp67_ = attrs;
									vala_parser_parse_field_declaration (self, _tmp66_, _tmp67_, &_inner_error_);
									if (_inner_error_ != NULL) {
										if (_inner_error_->domain == VALA_PARSE_ERROR) {
											g_propagate_error (error, _inner_error_);
											_vala_iterable_unref0 (attrs);
						...
						case VALA_TOKEN_TYPE_THROWS:
						{
							...
							_tmp69_ = parent;
							_tmp70_ = attrs;
							vala_parser_parse_property_declaration (self, _tmp69_, _tmp70_, &_inner_error_);
							if (_inner_error_ != NULL) {
								if (_inner_error_->domain == VALA_PARSE_ERROR) {
									g_propagate_error (error, _inner_error_);
									_vala_iterable_unref0 (attrs);
	...
	_tmp71_ = begin;
	vala_parser_rollback (self, &_tmp71_);
	_tmp72_ = vala_parser_get_error (self, "expected declaration");
	_tmp73_ = _tmp72_;
	_tmp74_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, _tmp73_);
	_tmp75_ = _tmp74_;
	_g_free0 (_tmp73_);
...
static void vala_parser_parse_declarations (ValaParser* self, ValaSymbol* parent, gboolean root, GError** error) {
	...
	while (TRUE) {
		...
		}
		{
			...
			_tmp9_ = _tmp8_;
			vala_parser_parse_declaration (self, _tmp5_, _tmp6_ == VALA_SYMBOL (_tmp9_), &_inner_error_);
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
...
static void vala_parser_parse_namespace_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		_tmp54_ = next;
		_tmp55_ = _result_;
		vala_symbol_add_namespace (_tmp54_, VALA_NAMESPACE (_tmp55_));
		_tmp56_ = next;
...
static void vala_parser_parse_class_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		next = _tmp111_;
		_tmp112_ = _result_;
		if (VALA_IS_NAMESPACE (_tmp112_)) {
			ValaSymbol* _tmp113_;
			ValaSymbol* _tmp114_;
			_tmp113_ = next;
			_tmp114_ = _result_;
			vala_symbol_add_namespace (_tmp113_, VALA_NAMESPACE (_tmp114_));
		} else {
			ValaSymbol* _tmp115_;
			ValaSymbol* _tmp116_;
			_tmp115_ = next;
			_tmp116_ = _result_;
			vala_symbol_add_class (_tmp115_, VALA_CLASS (_tmp116_));
		}
		_tmp117_ = next;
...
static void vala_parser_parse_field_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	_tmp6_ = vala_parser_parse_type (self, TRUE, TRUE, &_inner_error_);
	type = _tmp6_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_PARSE_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	if ((_tmp29_ & VALA_PARSER_MODIFIER_FLAGS_ABSTRACT) == VALA_PARSER_MODIFIER_FLAGS_ABSTRACT) {
		...
		_tmp30_ = flags;
		_tmp28_ = (_tmp30_ & VALA_PARSER_MODIFIER_FLAGS_VIRTUAL) == VALA_PARSER_MODIFIER_FLAGS_VIRTUAL;
	}
	_tmp31_ = _tmp28_;
	if (_tmp31_) {
		_tmp27_ = TRUE;
		...
		_tmp32_ = flags;
		_tmp27_ = (_tmp32_ & VALA_PARSER_MODIFIER_FLAGS_OVERRIDE) == VALA_PARSER_MODIFIER_FLAGS_OVERRIDE;
	}
	_tmp33_ = _tmp27_;
	if (_tmp33_) {
		ValaField* _tmp34_;
		...
		_tmp36_ = _tmp35_;
		vala_report_error (_tmp36_, "abstract, virtual, and override modifiers are not applicable to fields");
	}
	_tmp38_ = flags;
	if ((_tmp38_ & VALA_PARSER_MODIFIER_FLAGS_EXTERN) == VALA_PARSER_MODIFIER_FLAGS_EXTERN) {
		_tmp37_ = TRUE;
	} else {
		ValaScanner* _tmp39_;
		...
		_tmp40_ = vala_scanner_get_source_file (_tmp39_);
		_tmp41_ = _tmp40_;
	...
	if (_tmp44_) {
		ValaField* _tmp45_;
		_tmp45_ = f;
		vala_symbol_set_external ((ValaSymbol*) _tmp45_, TRUE);
	}
	_tmp46_ = flags;
	if ((_tmp46_ & VALA_PARSER_MODIFIER_FLAGS_NEW) == VALA_PARSER_MODIFIER_FLAGS_NEW) {
		ValaField* _tmp47_;
		_tmp47_ = f;
		vala_symbol_set_hides ((ValaSymbol*) _tmp47_, TRUE);
	}
	...
	if (_tmp48_) {
		...
		_tmp51_ = f;
		_tmp52_ = _tmp50_;
		vala_variable_set_initializer ((ValaVariable*) _tmp51_, _tmp52_);
	...
	_tmp53_ = parent;
	_tmp54_ = f;
	vala_symbol_add_field (_tmp53_, _tmp54_);
	_vala_code_node_unref0 (f);
	_g_free0 (id);
	_vala_code_node_unref0 (type);
}
	...
	if (_tmp6_ != VALA_TOKEN_TYPE_CLOSE_BRACE) {
		{
			...
			while (TRUE) {
				...
				_tmp7_ = FALSE;
				_tmp10_ = vala_parser_parse_argument (self, &_inner_error_);
				init = _tmp10_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
				...
				_tmp11_ = initializer;
				_tmp12_ = init;
				vala_initializer_list_append (_tmp11_, _tmp12_);
				_vala_code_node_unref0 (init);
			}
		}
	}
...
static ValaListLiteral* vala_parser_parse_list_literal (ValaParser* self, GError** error) {
	...
	ValaSourceReference* _tmp2_ = NULL;
	ValaSourceReference* _tmp3_;
	ValaListLiteral* _tmp4_;
	ValaListLiteral* _tmp5_;
	...
	if (_tmp6_ != VALA_TOKEN_TYPE_CLOSE_BRACKET) {
		{
			...
			while (TRUE) {
				...
				_tmp11_ = initializer;
				_tmp12_ = init;
				vala_list_literal_add_expression (_tmp11_, _tmp12_);
				_vala_code_node_unref0 (init);
			}
		}
	}
...
static ValaExpression* vala_parser_parse_set_literal (ValaParser* self, GError** error) {
	...
	ValaSourceReference* _tmp2_ = NULL;
	ValaSourceReference* _tmp3_;
	ValaSetLiteral* _tmp4_;
	ValaSetLiteral* _tmp5_;
	ValaSetLiteral* set;
	gboolean first;
	ValaTokenType _tmp6_ = 0;
	GError * _inner_error_ = NULL;
	...
	if (_tmp6_ != VALA_TOKEN_TYPE_CLOSE_BRACE) {
		{
			...
			while (TRUE) {
				...
				if (_tmp12_) {
					gboolean _tmp13_ = FALSE;
					_tmp13_ = vala_parser_accept (self, VALA_TOKEN_TYPE_COLON);
					_tmp11_ = _tmp13_;
				} else {
					_tmp11_ = FALSE;
				}
				...
				if (_tmp14_) {
					...
					_tmp15_ = begin;
					vala_parser_rollback (self, &_tmp15_);
					_tmp16_ = vala_parser_parse_map_literal (self, &_inner_error_);
					_tmp17_ = _tmp16_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
				...
				_tmp18_ = set;
				_tmp19_ = expr;
				vala_set_literal_add_expression (_tmp18_, _tmp19_);
				_vala_code_node_unref0 (expr);
			}
		}
	}
...
static ValaExpression* vala_parser_parse_map_literal (ValaParser* self, GError** error) {
	...
	ValaSourceReference* _tmp2_ = NULL;
	ValaSourceReference* _tmp3_;
	ValaMapLiteral* _tmp4_;
	ValaMapLiteral* _tmp5_;
	ValaMapLiteral* map;
	ValaTokenType _tmp6_ = 0;
	GError * _inner_error_ = NULL;
	g_return_val_if_fail (self != NULL, NULL);
	...
	if (_tmp6_ != VALA_TOKEN_TYPE_CLOSE_BRACE) {
		{
			...
			while (TRUE) {
				...
				ValaExpression* _tmp10_ = NULL;
				ValaExpression* key;
				ValaMapLiteral* _tmp11_;
				ValaExpression* _tmp12_;
				ValaExpression* _tmp13_ = NULL;
				ValaExpression* value;
				ValaMapLiteral* _tmp14_;
				ValaExpression* _tmp15_;
				_tmp8_ = _tmp7_;
				if (!_tmp8_) {
					gboolean _tmp9_ = FALSE;
				...
				_tmp11_ = map;
				_tmp12_ = key;
				vala_map_literal_add_key (_tmp11_, _tmp12_);
				vala_parser_expect (self, VALA_TOKEN_TYPE_COLON, &_inner_error_);
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
				...
				_tmp14_ = map;
				_tmp15_ = value;
				vala_map_literal_add_value (_tmp14_, _tmp15_);
...
"static methods");
	...
	if (_tmp104_ == VALA_PROFILE_DOVA) {
		...
		ValaUnresolvedType* _tmp113_;
		ValaUnresolvedType* error_type;
		ValaMethod* _tmp114_;
		ValaUnresolvedType* _tmp115_;
		gboolean _tmp116_ = FALSE;
		_tmp105_ = vala_unresolved_symbol_new (NULL, "Dova", NULL);
		_tmp106_ = _tmp105_;
		_tmp107_ = vala_unresolved_symbol_new (_tmp106_, "Error", NULL);
		_tmp108_ = _tmp107_;
		_tmp109_ = method;
		_tmp110_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp109_);
		_tmp111_ = _tmp110_;
		_tmp112_ = vala_unresolved_type_new_from_symbol (_tmp108_, _tmp111_);
		_tmp113_ = _tmp112_;
		...
		_tmp114_ = method;
		_tmp115_ = error_type;
		vala_code_node_add_error_type ((ValaCodeNode*) _tmp114_, (ValaDataType*) _tmp115_);
		_tmp116_ = vala_parser_accept (self, VALA_TOKEN_TYPE_THROWS);
		if (_tmp116_) {
			ValaMethod* _tmp122_;
			...
			ValaSourceReference* _tmp124_;
			{
				...
				while (TRUE) {
					...
					if (!_tmp118_) {
						...
						_tmp119_ = vala_parser_accept (self, VALA_TOKEN_TYPE_COMMA);
						if (!_tmp119_) {
							break;
						}
					}
					_tmp117_ = FALSE;
					_tmp120_ = vala_parser_parse_type (self, TRUE, FALSE, &_inner_error_);
					_tmp121_ = _tmp120_;
			...
			_tmp124_ = _tmp123_;
			vala_report_warning (_tmp124_, "`throws' is ignored in the Dova profile");
		}
		_vala_code_node_unref0 (error_type);
	} else {
		gboolean _tmp125_ = FALSE;
		_tmp125_ = vala_parser_accept (self, VALA_TOKEN_TYPE_THROWS);
		if (_tmp125_) {
			{
				gboolean _tmp126_;
				_tmp126_ = TRUE;
				while (TRUE) {
					...
					if (!_tmp127_) {
						...
						_tmp128_ = vala_parser_accept (self, VALA_TOKEN_TYPE_COMMA);
						if (!_tmp128_) {
							break;
						}
					}
					_tmp126_ = FALSE;
					_tmp129_ = vala_parser_parse_type (self, TRUE, FALSE, &_inner_error_);
					_tmp130_ = _tmp129_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
					...
					_tmp131_ = method;
					_tmp132_ = _tmp130_;
					vala_code_node_add_error_type ((ValaCodeNode*) _tmp131_, _tmp132_);
	...
	while (TRUE) {
		...
		_tmp133_ = vala_parser_accept (self, VALA_TOKEN_TYPE_REQUIRES);
		if (!_tmp133_) {
			break;
		}
		vala_parser_expect (self, VALA_TOKEN_TYPE_OPEN_PARENS, &_inner_error_);
		...
		_tmp134_ = vala_parser_parse_expression (self, &_inner_error_);
		_tmp135_ = _tmp134_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp136_ = method;
		_tmp137_ = _tmp135_;
		vala_method_add_precondition (_tmp136_, _tmp137_);
	...
	while (TRUE) {
		...
		_tmp138_ = vala_parser_accept (self, VALA_TOKEN_TYPE_ENSURES);
		if (!_tmp138_) {
			break;
		}
		vala_parser_expect (self, VALA_TOKEN_TYPE_OPEN_PARENS, &_inner_error_);
		...
		_tmp139_ = vala_parser_parse_expression (self, &_inner_error_);
		_tmp140_ = _tmp139_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp141_ = method;
		_tmp142_ = _tmp140_;
		vala_method_add_postcondition (_tmp141_, _tmp142_);
	...
	_tmp143_ = vala_parser_accept (self, VALA_TOKEN_TYPE_SEMICOLON);
	if (!_tmp143_) {
		ValaBlock* _tmp144_ = NULL;
		ValaBlock* _tmp145_;
		ValaMethod* _tmp146_;
		ValaBlock* _tmp147_;
		_tmp144_ = vala_parser_parse_block (self, &_inner_error_);
		_tmp145_ = _tmp144_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp146_ = method;
		_tmp147_ = _tmp145_;
		vala_subroutine_set_body ((ValaSubroutine*) _tmp146_, _tmp147_);
		_vala_code_node_unref0 (_tmp147_);
	} else {
		ValaScanner* _tmp148_;
		ValaSourceFile* _tmp149_;
		ValaSourceFile* _tmp150_;
		ValaSourceFileType _tmp151_;
		ValaSourceFileType _tmp152_;
		_tmp148_ = self->priv->scanner;
		_tmp149_ = vala_scanner_get_source_file (_tmp148_);
		_tmp150_ = _tmp149_;
		_tmp151_ = vala_source_file_get_file_type (_tmp150_);
		_tmp152_ = _tmp151_;
		if (_tmp152_ == VALA_SOURCE_FILE_TYPE_PACKAGE) {
			ValaMethod* _tmp153_;
			_tmp153_ = method;
			vala_symbol_set_external ((ValaSymbol*) _tmp153_, TRUE);
		}
	}
	_tmp154_ = parent;
	_tmp155_ = method;
	vala_symbol_add_method (_tmp154_, _tmp155_);
	_vala_code_node_unref0 (method);
	_vala_iterable_unref0 (type_param_list);
	_g_free0 (id);
	_vala_code_node_unref0 (type);
...
static void vala_parser_parse_property_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	if (_tmp6_ == VALA_PROFILE_DOVA) {
		...
		gboolean _tmp7_ = FALSE;
		_tmp7_ = vala_parser_accept (self, VALA_TOKEN_TYPE_HASH);
		if (_tmp7_) {
			ValaCodeContext* _tmp8_;
			gboolean _tmp9_;
			gboolean _tmp10_;
			...
			if (!_tmp10_) {
				...
				_tmp12_ = _tmp11_;
				vala_report_warning (_tmp12_, "deprecated syntax, use `owned` modifier before `get'");
				_vala_source_reference_unref0 (_tmp12_);
			}
			getter_owned = TRUE;
		}
	...
	_tmp20_ = vala_property_new (_tmp14_, _tmp15_, NULL, NULL, _tmp18_, _tmp19_);
	_tmp21_ = _tmp20_;
	_vala_source_reference_unref0 (_tmp18_);
	prop = _tmp21_;
	_tmp22_ = prop;
	...
	_tmp26_ = flags;
	if ((_tmp26_ & VALA_PARSER_MODIFIER_FLAGS_STATIC) == VALA_PARSER_MODIFIER_FLAGS_STATIC) {
		ValaProperty* _tmp27_;
		_tmp27_ = prop;
		vala_property_set_binding (_tmp27_, VALA_MEMBER_BINDING_STATIC);
	} else {
		ValaParserModifierFlags _tmp28_;
		_tmp28_ = flags;
		if ((_tmp28_ & VALA_PARSER_MODIFIER_FLAGS_CLASS) == VALA_PARSER_MODIFIER_FLAGS_CLASS) {
			ValaProperty* _tmp29_;
			_tmp29_ = prop;
			vala_property_set_binding (_tmp29_, VALA_MEMBER_BINDING_CLASS);
		}
	}
	_tmp30_ = flags;
	if ((_tmp30_ & VALA_PARSER_MODIFIER_FLAGS_ABSTRACT) == VALA_PARSER_MODIFIER_FLAGS_ABSTRACT) {
		ValaProperty* _tmp31_;
		_tmp31_ = prop;
		vala_property_set_is_abstract (_tmp31_, TRUE);
	}
	_tmp32_ = flags;
	if ((_tmp32_ & VALA_PARSER_MODIFIER_FLAGS_VIRTUAL) == VALA_PARSER_MODIFIER_FLAGS_VIRTUAL) {
		ValaProperty* _tmp33_;
		_tmp33_ = prop;
		vala_property_set_is_virtual (_tmp33_, TRUE);
	}
	_tmp34_ = flags;
	if ((_tmp34_ & VALA_PARSER_MODIFIER_FLAGS_OVERRIDE) == VALA_PARSER_MODIFIER_FLAGS_OVERRIDE) {
		ValaProperty* _tmp35_;
		_tmp35_ = prop;
		vala_property_set_overrides (_tmp35_, TRUE);
	}
	_tmp36_ = flags;
	if ((_tmp36_ & VALA_PARSER_MODIFIER_FLAGS_NEW) == VALA_PARSER_MODIFIER_FLAGS_NEW) {
	...
	_tmp43_ = flags;
	if ((_tmp43_ & VALA_PARSER_MODIFIER_FLAGS_EXTERN) == VALA_PARSER_MODIFIER_FLAGS_EXTERN) {
		_tmp42_ = TRUE;
	} else {
		ValaScanner* _tmp44_;
		...
		_tmp45_ = vala_scanner_get_source_file (_tmp44_);
		_tmp46_ = _tmp45_;
		_tmp47_ = vala_source_file_get_file_type (_tmp46_);
		_tmp48_ = _tmp47_;
		_tmp42_ = _tmp48_ == VALA_SOURCE_FILE_TYPE_PACKAGE;
	}
	_tmp49_ = _tmp42_;
	if (_tmp49_) {
	...
	if (_tmp53_ == VALA_PROFILE_DOVA) {
		...
		if (_tmp54_) {
			...
			_tmp64_ = _tmp63_;
			vala_report_error (_tmp64_, "properties throwing errors are not supported yet");
		}
	}
	vala_parser_expect (self, VALA_TOKEN_TYPE_OPEN_BRACE, &_inner_error_);
	if (_inner_error_ != NULL) {
	...
	while (TRUE) {
		...
		if (!(_tmp65_ != VALA_TOKEN_TYPE_CLOSE_BRACE)) {
			break;
		}
		_tmp66_ = vala_parser_accept (self, VALA_TOKEN_TYPE_DEFAULT);
		if (_tmp66_) {
			...
			if (_tmp69_ != NULL) {
				...
				GError* _tmp72_;
				GError* _tmp73_;
				_tmp70_ = vala_parser_get_error (self, "property default value already defined");
				_tmp71_ = _tmp70_;
			...
			_tmp74_ = vala_parser_parse_expression (self, &_inner_error_);
			_tmp75_ = _tmp74_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
			...
			_tmp76_ = prop;
			_tmp77_ = _tmp75_;
			vala_property_set_initializer (_tmp76_, _tmp77_);
			...
			_tmp78_ = self->priv->scanner;
			_tmp79_ = vala_scanner_pop_comment (_tmp78_);
			_vala_comment_unref0 (self->priv->comment);
			self->priv->comment = _tmp79_;
			vala_parser_get_location (self, &_tmp80_);
			accessor_begin = _tmp80_;
			_tmp81_ = vala_parser_parse_attributes (self, &_inner_error_);
			accessor_attrs = _tmp81_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
					_vala_code_node_unref0 (prop);
			...
			_tmp82_ = vala_parser_parse_access_modifier (self, VALA_SYMBOL_ACCESSIBILITY_PUBLIC);
			accessor_access = _tmp82_;
			_tmp83_ = type;
			_tmp84_ = vala_data_type_copy (_tmp83_);
			value_type = _tmp84_;
			_tmp86_ = self->priv->context;
			_tmp87_ = vala_code_context_get_profile (_tmp86_);
			_tmp88_ = _tmp87_;
			if (_tmp88_ != VALA_PROFILE_DOVA) {
				gboolean _tmp89_ = FALSE;
				_tmp89_ = vala_parser_accept (self, VALA_TOKEN_TYPE_OWNED);
				_tmp85_ = _tmp89_;
			} else {
				_tmp85_ = FALSE;
			}
			...
			_tmp92_ = vala_parser_accept (self, VALA_TOKEN_TYPE_GET);
			if (_tmp92_) {
				...
				if (_tmp95_ != NULL) {
					...
					GError* _tmp98_;
					GError* _tmp99_;
					_tmp96_ = vala_parser_get_error (self, "property get accessor already defined");
					_tmp97_ = _tmp96_;
				...
				_tmp100_ = getter_owned;
				if (_tmp100_) {
					ValaDataType* _tmp101_;
					_tmp101_ = value_type;
					vala_data_type_set_value_owned (_tmp101_, TRUE);
				}
				block = NULL;
				_tmp102_ = vala_parser_accept (self, VALA_TOKEN_TYPE_SEMICOLON);
				if (!_tmp102_) {
					ValaBlock* _tmp103_ = NULL;
					ValaBlock* _tmp104_;
					ValaProperty* _tmp105_;
					_tmp103_ = vala_parser_parse_block (self, &_inner_error_);
					_tmp104_ = _tmp103_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
					...
					block = _tmp104_;
					_tmp105_ = prop;
					vala_symbol_set_external ((ValaSymbol*) _tmp105_, FALSE);
				}
				_tmp106_ = prop;
				_tmp107_ = value_type;
				_tmp108_ = block;
				_tmp109_ = accessor_begin;
				_tmp110_ = vala_parser_get_src (self, &_tmp109_);
				_tmp111_ = _tmp110_;
				_tmp112_ = self->priv->comment;
				_tmp113_ = vala_property_accessor_new (TRUE, FALSE, FALSE, _tmp107_, _tmp108_, _tmp111_, _tmp112_);
				_tmp114_ = _tmp113_;
				vala_property_set_get_accessor (_tmp106_, _tmp114_);
				_vala_code_node_unref0 (_tmp114_);
				_vala_source_reference_unref0 (_tmp111_);
				_tmp115_ = prop;
				_tmp116_ = vala_property_get_get_accessor (_tmp115_);
				_tmp117_ = _tmp116_;
				_tmp118_ = accessor_attrs;
				vala_parser_set_attributes (self, (ValaCodeNode*) _tmp117_, _tmp118_);
				_tmp119_ = prop;
				_tmp120_ = vala_property_get_get_accessor (_tmp119_);
				_tmp121_ = _tmp120_;
				_tmp122_ = accessor_access;
				vala_symbol_set_access ((ValaSymbol*) _tmp121_, _tmp122_);
				_vala_code_node_unref0 (block);
			} else {
				...
				_tmp123_ = vala_parser_accept (self, VALA_TOKEN_TYPE_SET);
				if (_tmp123_) {
					...
					_tmp132_ = vala_code_context_get_profile (_tmp131_);
					_tmp133_ = _tmp132_;
					if (_tmp133_ == VALA_PROFILE_GOBJECT) {
						gboolean _tmp134_ = FALSE;
						_tmp134_ = vala_parser_accept (self, VALA_TOKEN_TYPE_CONSTRUCT);
						_tmp130_ = _tmp134_;
					} else {
						_tmp130_ = FALSE;
					}
					...
					if (_tmp135_) {
						...
						GError* _tmp139_;
						GError* _tmp140_;
						_tmp137_ = vala_parser_get_error (self, "expected get, set, or construct");
						_tmp138_ = _tmp137_;
						_tmp139_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, _tmp138_);
						_tmp140_ = _tmp139_;
						_g_free0 (_tmp138_);
				...
				_tmp141_ = prop;
				_tmp142_ = vala_property_get_set_accessor (_tmp141_);
				_tmp143_ = _tmp142_;
				if (_tmp143_ != NULL) {
					gchar* _tmp144_ = NULL;
					gchar* _tmp145_;
					GError* _tmp146_;
					GError* _tmp147_;
					_tmp144_ = vala_parser_get_error (self, "property set accessor already defined");
					_tmp145_ = _tmp144_;
					_tmp146_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, _tmp145_);
					_tmp147_ = _tmp146_;
					_g_free0 (_tmp145_);
				...
				block = NULL;
				_tmp148_ = vala_parser_accept (self, VALA_TOKEN_TYPE_SEMICOLON);
				if (!_tmp148_) {
					ValaBlock* _tmp149_ = NULL;
					ValaBlock* _tmp150_;
					ValaProperty* _tmp151_;
					_tmp149_ = vala_parser_parse_block (self, &_inner_error_);
					_tmp150_ = _tmp149_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
					...
					block = _tmp150_;
					_tmp151_ = prop;
					vala_symbol_set_external ((ValaSymbol*) _tmp151_, FALSE);
				}
				_tmp152_ = prop;
				_tmp153_ = writable;
				_tmp154_ = _construct;
				_tmp155_ = value_type;
				_tmp156_ = block;
				_tmp157_ = accessor_begin;
				_tmp158_ = vala_parser_get_src (self, &_tmp157_);
				_tmp159_ = _tmp158_;
				_tmp160_ = self->priv->comment;
				_tmp161_ = vala_property_accessor_new (FALSE, _tmp153_, _tmp154_, _tmp155_, _tmp156_, _tmp159_, _tmp160_);
				_tmp162_ = _tmp161_;
				vala_property_set_set_accessor (_tmp152_, _tmp162_);
				_vala_code_node_unref0 (_tmp162_);
				_vala_source_reference_unref0 (_tmp159_);
				_tmp163_ = prop;
				_tmp164_ = vala_property_get_set_accessor (_tmp163_);
				_tmp165_ = _tmp164_;
				_tmp166_ = accessor_attrs;
				vala_parser_set_attributes (self, (ValaCodeNode*) _tmp165_, _tmp166_);
				_tmp167_ = prop;
				_tmp168_ = vala_property_get_set_accessor (_tmp167_);
				_tmp169_ = _tmp168_;
				_tmp170_ = accessor_access;
				vala_symbol_set_access ((ValaSymbol*) _tmp169_, _tmp170_);
				_vala_code_node_unref0 (block);
			}
			_vala_code_node_unref0 (value_type);
			_vala_iterable_unref0 (accessor_attrs);
	...
	if (!_tmp174_) {
		...
		_tmp175_ = prop;
		_tmp176_ = vala_symbol_get_source_type ((ValaSymbol*) _tmp175_);
		_tmp177_ = _tmp176_;
		_tmp171_ = _tmp177_ == VALA_SOURCE_FILE_TYPE_SOURCE;
	} else {
		_tmp171_ = FALSE;
	}
	_tmp178_ = _tmp171_;
	if (_tmp178_) {
		...
		if (_tmp182_ != NULL) {
			...
			_tmp185_ = _tmp184_;
			_tmp186_ = vala_subroutine_get_body ((ValaSubroutine*) _tmp185_);
			_tmp187_ = _tmp186_;
		...
		empty_get = _tmp188_;
		_tmp190_ = prop;
		_tmp191_ = vala_property_get_set_accessor (_tmp190_);
		_tmp192_ = _tmp191_;
		if (_tmp192_ != NULL) {
		...
		if (_tmp199_ != _tmp200_) {
			...
			if (_tmp201_) {
				...
				_tmp204_ = _tmp203_;
				vala_report_error (_tmp204_, "property getter must have a body");
			} else {
				gboolean _tmp205_;
				_tmp205_ = empty_set;
				if (_tmp205_) {
					...
					_tmp208_ = _tmp207_;
					vala_report_error (_tmp208_, "property setter must have a body");
				}
			}
			_tmp209_ = prop;
			vala_code_node_set_error ((ValaCodeNode*) _tmp209_, TRUE);
		}
		_tmp211_ = empty_get;
		if (_tmp211_) {
			gboolean _tmp212_;
		...
		if (_tmp213_) {
			...
			_tmp242_ = prop;
			_tmp243_ = vala_property_get_initializer (_tmp242_);
			_tmp244_ = _tmp243_;
			if (_tmp244_ != NULL) {
				...
				_tmp245_ = prop;
				_tmp246_ = vala_property_get_initializer (_tmp245_);
				_tmp247_ = _tmp246_;
				_tmp248_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp247_);
				_tmp249_ = _tmp248_;
				vala_report_error (_tmp249_, "only automatic properties can have default values");
			}
		}
	}
	_tmp250_ = parent;
	_tmp251_ = prop;
	vala_symbol_add_property (_tmp250_, _tmp251_);
	_vala_code_node_unref0 (prop);
	_g_free0 (id);
	_vala_code_node_unref0 (type);
}
...
static void vala_parser_parse_struct_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		if (VALA_IS_NAMESPACE (_tmp67_)) {
			...
			_tmp68_ = next;
			_tmp69_ = _result_;
			vala_symbol_add_namespace (_tmp68_, VALA_NAMESPACE (_tmp69_));
		} else {
			ValaSymbol* _tmp70_;
			ValaSymbol* _tmp71_;
			_tmp70_ = next;
			_tmp71_ = _result_;
			vala_symbol_add_struct (_tmp70_, VALA_STRUCT (_tmp71_));
		}
		_tmp72_ = next;
...
static void vala_parser_parse_interface_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		next = _tmp82_;
		_tmp83_ = _result_;
		if (VALA_IS_NAMESPACE (_tmp83_)) {
			ValaSymbol* _tmp84_;
			ValaSymbol* _tmp85_;
			_tmp84_ = next;
			_tmp85_ = _result_;
			vala_symbol_add_namespace (_tmp84_, VALA_NAMESPACE (_tmp85_));
		} else {
			ValaSymbol* _tmp86_;
			ValaSymbol* _tmp87_;
			_tmp86_ = next;
			_tmp87_ = _result_;
			vala_symbol_add_interface (_tmp86_, VALA_INTERFACE (_tmp87_));
		}
		_tmp88_ = next;
...
static void vala_parser_parse_enum_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		next = _tmp80_;
		_tmp81_ = _result_;
		if (VALA_IS_NAMESPACE (_tmp81_)) {
			ValaSymbol* _tmp82_;
			ValaSymbol* _tmp83_;
			_tmp82_ = next;
			_tmp83_ = _result_;
			vala_symbol_add_namespace (_tmp82_, VALA_NAMESPACE (_tmp83_));
		} else {
			ValaSymbol* _tmp84_;
			ValaSymbol* _tmp85_;
			_tmp84_ = next;
			_tmp85_ = _result_;
			vala_symbol_add_enum (_tmp84_, VALA_ENUM (_tmp85_));
		}
		_tmp86_ = next;
...
static void vala_parser_parse_errordomain_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		if (VALA_IS_NAMESPACE (_tmp81_)) {
			...
			_tmp84_ = next;
			_tmp85_ = _result_;
			vala_symbol_add_error_domain (_tmp84_, VALA_ERROR_DOMAIN (_tmp85_));
		}
		_tmp86_ = next;
		_tmp87_ = _vala_code_node_ref0 (_tmp86_);
		_vala_code_node_unref0 (_result_);
...
static ValaParameter* vala_parser_parse_parameter (ValaParser* self, GError** error) {
	...
	if (_tmp14_ == VALA_PARAMETER_DIRECTION_IN) {
		...
		ValaDataType* _tmp16_;
		_tmp15_ = vala_parser_parse_type (self, FALSE, FALSE, &_inner_error_);
		_tmp16_ = _tmp15_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp17_ = direction;
		if (_tmp17_ == VALA_PARAMETER_DIRECTION_REF) {
			ValaDataType* _tmp18_ = NULL;
			ValaDataType* _tmp19_;
			_tmp18_ = vala_parser_parse_type (self, TRUE, TRUE, &_inner_error_);
			_tmp19_ = _tmp18_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
	...
	_tmp23_ = type;
	_tmp24_ = vala_parser_parse_inline_array_type (self, _tmp23_, &_inner_error_);
	_tmp25_ = _tmp24_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_PARSE_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	_tmp29_ = vala_parser_get_src (self, &_tmp28_);
	_tmp30_ = _tmp29_;
	_tmp31_ = vala_parameter_new (_tmp26_, _tmp27_, _tmp30_);
	_tmp32_ = _tmp31_;
	_vala_source_reference_unref0 (_tmp30_);
	param = _tmp32_;
	_tmp33_ = param;
	...
	_tmp35_ = param;
	_tmp36_ = direction;
	vala_parameter_set_direction (_tmp35_, _tmp36_);
	_tmp37_ = param;
	_tmp38_ = params_array;
	vala_parameter_set_params_array (_tmp37_, _tmp38_);
	...
	if (_tmp39_) {
		...
		_tmp42_ = param;
		_tmp43_ = _tmp41_;
		vala_variable_set_initializer ((ValaVariable*) _tmp42_, _tmp43_);
...
"on methods");
	...
	if (_tmp56_ == VALA_PROFILE_DOVA) {
		...
		gboolean _tmp68_ = FALSE;
		_tmp57_ = vala_unresolved_symbol_new (NULL, "Dova", NULL);
		_tmp58_ = _tmp57_;
		_tmp59_ = vala_unresolved_symbol_new (_tmp58_, "Error", NULL);
		_tmp60_ = _tmp59_;
		_tmp61_ = method;
		_tmp62_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp61_);
		_tmp63_ = _tmp62_;
		_tmp64_ = vala_unresolved_type_new_from_symbol (_tmp60_, _tmp63_);
		_tmp65_ = _tmp64_;
		...
		_tmp66_ = method;
		_tmp67_ = error_type;
		vala_code_node_add_error_type ((ValaCodeNode*) _tmp66_, (ValaDataType*) _tmp67_);
		_tmp68_ = vala_parser_accept (self, VALA_TOKEN_TYPE_THROWS);
		if (_tmp68_) {
			...
			ValaSourceReference* _tmp76_;
			{
				...
				while (TRUE) {
					...
					if (!_tmp70_) {
						...
						_tmp71_ = vala_parser_accept (self, VALA_TOKEN_TYPE_COMMA);
						if (!_tmp71_) {
							break;
						}
					}
					_tmp69_ = FALSE;
					_tmp72_ = vala_parser_parse_type (self, TRUE, FALSE, &_inner_error_);
					_tmp73_ = _tmp72_;
			...
			_tmp75_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp74_);
			_tmp76_ = _tmp75_;
			vala_report_warning (_tmp76_, "`throws' is ignored in the Dova profile");
		}
		_vala_code_node_unref0 (error_type);
	} else {
		gboolean _tmp77_ = FALSE;
		_tmp77_ = vala_parser_accept (self, VALA_TOKEN_TYPE_THROWS);
		if (_tmp77_) {
			{
				gboolean _tmp78_;
				_tmp78_ = TRUE;
				while (TRUE) {
					...
					if (!_tmp79_) {
						gboolean _tmp80_ = FALSE;
						_tmp80_ = vala_parser_accept (self, VALA_TOKEN_TYPE_COMMA);
						if (!_tmp80_) {
							break;
						}
					}
					_tmp78_ = FALSE;
					_tmp81_ = vala_parser_parse_type (self, TRUE, FALSE, &_inner_error_);
					_tmp82_ = _tmp81_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
					...
					_tmp83_ = method;
					_tmp84_ = _tmp82_;
					vala_code_node_add_error_type ((ValaCodeNode*) _tmp83_, _tmp84_);
					_vala_code_node_unref0 (_tmp84_);
				}
			}
		}
	...
	while (TRUE) {
		...
		_tmp85_ = vala_parser_accept (self, VALA_TOKEN_TYPE_REQUIRES);
		if (!_tmp85_) {
			break;
		}
		vala_parser_expect (self, VALA_TOKEN_TYPE_OPEN_PARENS, &_inner_error_);
		...
		_tmp86_ = vala_parser_parse_expression (self, &_inner_error_);
		_tmp87_ = _tmp86_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp88_ = method;
		_tmp89_ = _tmp87_;
		vala_method_add_precondition ((ValaMethod*) _tmp88_, _tmp89_);
		_vala_code_node_unref0 (_tmp89_);
		vala_parser_expect (self, VALA_TOKEN_TYPE_CLOSE_PARENS, &_inner_error_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
	...
	while (TRUE) {
		...
		_tmp90_ = vala_parser_accept (self, VALA_TOKEN_TYPE_ENSURES);
		if (!_tmp90_) {
			break;
		}
		vala_parser_expect (self, VALA_TOKEN_TYPE_OPEN_PARENS, &_inner_error_);
		...
		_tmp91_ = vala_parser_parse_expression (self, &_inner_error_);
		_tmp92_ = _tmp91_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp93_ = method;
		_tmp94_ = _tmp92_;
		vala_method_add_postcondition ((ValaMethod*) _tmp93_, _tmp94_);
	...
	_tmp95_ = method;
	_tmp96_ = access;
	vala_symbol_set_access ((ValaSymbol*) _tmp95_, _tmp96_);
	_tmp97_ = method;
	_tmp98_ = attrs;
	vala_parser_set_attributes (self, (ValaCodeNode*) _tmp97_, _tmp98_);
	_tmp99_ = vala_parser_accept (self, VALA_TOKEN_TYPE_SEMICOLON);
	if (!_tmp99_) {
		ValaBlock* _tmp100_ = NULL;
		ValaBlock* _tmp101_;
		ValaCreationMethod* _tmp102_;
		ValaBlock* _tmp103_;
		_tmp100_ = vala_parser_parse_block (self, &_inner_error_);
		_tmp101_ = _tmp100_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp102_ = method;
		_tmp103_ = _tmp101_;
		vala_subroutine_set_body ((ValaSubroutine*) _tmp102_, _tmp103_);
		...
		_tmp105_ = vala_scanner_get_source_file (_tmp104_);
		_tmp106_ = _tmp105_;
		_tmp107_ = vala_source_file_get_file_type (_tmp106_);
		_tmp108_ = _tmp107_;
		if (_tmp108_ == VALA_SOURCE_FILE_TYPE_PACKAGE) {
			ValaCreationMethod* _tmp109_;
			_tmp109_ = method;
			vala_symbol_set_external ((ValaSymbol*) _tmp109_, TRUE);
		}
	}
	_tmp110_ = parent;
	_tmp111_ = method;
	vala_symbol_add_method (_tmp110_, (ValaMethod*) _tmp111_);
	_vala_code_node_unref0 (method);
	_vala_code_node_unref0 (sym);
}
...
static void vala_parser_parse_delegate_declaration (ValaParser* self, ValaSymbol* parent, ValaList* attrs, GError** error) {
	...
	if (_tmp63_ == VALA_PROFILE_DOVA) {
		...
		_tmp64_ = vala_unresolved_symbol_new (NULL, "Dova", NULL);
		_tmp65_ = _tmp64_;
		_tmp66_ = vala_unresolved_symbol_new (_tmp65_, "Error", NULL);
		_tmp67_ = _tmp66_;
		_tmp68_ = d;
		_tmp69_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp68_);
		_tmp70_ = _tmp69_;
		_tmp71_ = vala_unresolved_type_new_from_symbol (_tmp67_, _tmp70_);
		_tmp72_ = _tmp71_;
		...
		_tmp73_ = d;
		_tmp74_ = error_type;
		vala_code_node_add_error_type ((ValaCodeNode*) _tmp73_, (ValaDataType*) _tmp74_);
		_tmp75_ = vala_parser_accept (self, VALA_TOKEN_TYPE_THROWS);
		if (_tmp75_) {
			...
			ValaSourceReference* _tmp83_;
			{
				...
				while (TRUE) {
					...
					if (!_tmp77_) {
						...
						_tmp78_ = vala_parser_accept (self, VALA_TOKEN_TYPE_COMMA);
						if (!_tmp78_) {
							break;
						}
					}
					_tmp76_ = FALSE;
					_tmp79_ = vala_parser_parse_type (self, TRUE, FALSE, &_inner_error_);
					_tmp80_ = _tmp79_;
			...
			_tmp83_ = _tmp82_;
			vala_report_warning (_tmp83_, "`throws' is ignored in the Dova profile");
		}
		_vala_code_node_unref0 (error_type);
	} else {
		gboolean _tmp84_ = FALSE;
		_tmp84_ = vala_parser_accept (self, VALA_TOKEN_TYPE_THROWS);
		if (_tmp84_) {
			{
				gboolean _tmp85_;
				_tmp85_ = TRUE;
				while (TRUE) {
					...
					if (!_tmp86_) {
						...
						_tmp87_ = vala_parser_accept (self, VALA_TOKEN_TYPE_COMMA);
						if (!_tmp87_) {
							break;
						}
					}
					_tmp85_ = FALSE;
					_tmp88_ = vala_parser_parse_type (self, TRUE, FALSE, &_inner_error_);
					_tmp89_ = _tmp88_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
					...
					_tmp90_ = d;
					_tmp91_ = _tmp89_;
					vala_code_node_add_error_type ((ValaCodeNode*) _tmp90_, _tmp91_);
	...
	while (TRUE) {
		...
		if (VALA_IS_NAMESPACE (_tmp112_)) {
			...
			_tmp115_ = next;
			_tmp116_ = _result_;
			vala_symbol_add_delegate (_tmp115_, VALA_DELEGATE (_tmp116_));
		}
		_tmp117_ = next;
		_tmp118_ = _vala_code_node_ref0 (_tmp117_);
		_vala_code_node_unref0 (_result_);
