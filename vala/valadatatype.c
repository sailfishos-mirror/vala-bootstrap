...
static gboolean vala_data_type_real_compatible (ValaDataType* self, ValaDataType* target_type) {
	...
	_tmp16_ = _tmp15_;
	_tmp17_ = _tmp16_ == VALA_PROFILE_GOBJECT;
	_vala_code_context_unref0 (_tmp14_);
	if (_tmp17_) {
		ValaDataType* _tmp18_;
		ValaTypeSymbol* _tmp19_;
		_tmp18_ = target_type;
		_tmp19_ = _tmp18_->priv->_data_type;
	...
	if (_tmp20_) {
		...
		gboolean _tmp40_;
		_tmp21_ = target_type;
		_tmp22_ = _tmp21_->priv->_data_type;
		_tmp23_ = vala_code_context_get ();
		_tmp24_ = _tmp23_;
		_tmp25_ = vala_code_context_get_analyzer (_tmp24_);
		_tmp26_ = _tmp25_;
		_tmp27_ = _tmp26_->gvalue_type;
		_tmp28_ = ((ValaDataType*) _tmp27_)->priv->_data_type;
		_tmp29_ = vala_typesymbol_is_subtype_of (_tmp22_, _tmp28_);
		_tmp30_ = _tmp29_;
		...
		_tmp31_ = target_type;
		_tmp32_ = _tmp31_->priv->_data_type;
		_tmp33_ = vala_code_context_get ();
		_tmp34_ = _tmp33_;
		_tmp35_ = vala_code_context_get_analyzer (_tmp34_);
		_tmp36_ = _tmp35_;
		_tmp37_ = _tmp36_->gvariant_type;
		_tmp38_ = ((ValaDataType*) _tmp37_)->priv->_data_type;
		_tmp39_ = vala_typesymbol_is_subtype_of (_tmp32_, _tmp38_);
		_tmp40_ = _tmp39_;
	...
	if (VALA_IS_VALUE_TYPE (self)) {
		...
		_tmp43_ = target_type;
		_tmp44_ = _tmp43_->priv->_data_type;
	...
	if (_tmp45_) {
		...
		gchar* _tmp49_;
		_tmp46_ = target_type;
		_tmp47_ = _tmp46_->priv->_data_type;
		_tmp48_ = vala_symbol_get_full_name ((ValaSymbol*) _tmp47_);
		_tmp49_ = _tmp48_;
		_tmp41_ = g_strcmp0 (_tmp49_, "Dova.Value") == 0;
		_g_free0 (_tmp49_);
	} else {
		_tmp41_ = FALSE;
	}
	...
	_tmp52_ = target_type;
	if (VALA_IS_DELEGATE_TYPE (_tmp52_)) {
		_tmp51_ = VALA_IS_DELEGATE_TYPE (self);
	} else {
		_tmp51_ = FALSE;
	}
	_tmp53_ = _tmp51_;
	if (_tmp53_) {
		...
		_tmp54_ = target_type;
		_tmp55_ = vala_delegate_type_get_delegate_symbol (VALA_DELEGATE_TYPE (_tmp54_));
		_tmp56_ = _tmp55_;
		_tmp57_ = vala_delegate_type_get_delegate_symbol (VALA_DELEGATE_TYPE (self));
		_tmp58_ = _tmp57_;
		result = _tmp56_ == _tmp58_;
		return result;
	}
	_tmp59_ = target_type;
	if (VALA_IS_POINTER_TYPE (_tmp59_)) {
		gboolean _tmp60_ = FALSE;
		ValaTypeParameter* _tmp61_;
		gboolean _tmp69_;
		_tmp61_ = self->priv->_type_parameter;
		if (_tmp61_ != NULL) {
			_tmp60_ = TRUE;
		} else {
			...
			if (_tmp63_ != NULL) {
				...
				_tmp66_ = vala_typesymbol_is_reference_type (_tmp65_);
				if (_tmp66_) {
					_tmp64_ = TRUE;
				} else {
					_tmp64_ = VALA_IS_DELEGATE_TYPE (self);
				}
				_tmp67_ = _tmp64_;
				_tmp62_ = _tmp67_;
			} else {
	...
	_tmp70_ = target_type;
	_tmp71_ = _tmp70_->priv->_type_parameter;
	if (_tmp71_ != NULL) {
		result = TRUE;
		return result;
	}
	_tmp72_ = target_type;
	if (VALA_IS_ARRAY_TYPE (self) != VALA_IS_ARRAY_TYPE (_tmp72_)) {
		result = FALSE;
		return result;
	}
	_tmp75_ = self->priv->_data_type;
	if (VALA_IS_ENUM (_tmp75_)) {
		ValaDataType* _tmp76_;
		ValaTypeSymbol* _tmp77_;
		_tmp76_ = target_type;
		_tmp77_ = _tmp76_->priv->_data_type;
		_tmp74_ = VALA_IS_STRUCT (_tmp77_);
	} else {
		_tmp74_ = FALSE;
	}
	_tmp78_ = _tmp74_;
	if (_tmp78_) {
		...
		_tmp79_ = target_type;
		_tmp80_ = _tmp79_->priv->_data_type;
		_tmp81_ = vala_struct_is_integer_type (VALA_STRUCT (_tmp80_));
		_tmp73_ = _tmp81_;
	} else {
		_tmp73_ = FALSE;
	}
	...
	_tmp83_ = self->priv->_data_type;
	_tmp84_ = target_type;
	_tmp85_ = _tmp84_->priv->_data_type;
	if (_tmp83_ == _tmp85_) {
		...
		gboolean _tmp92_;
		gboolean _tmp101_;
		_tmp88_ = self->priv->type_argument_list;
		if (_tmp88_ != NULL) {
			ValaList* _tmp89_;
			gint _tmp90_;
			gint _tmp91_;
		...
		if (_tmp101_) {
			{
				...
				i = 0;
				{
					...
					while (TRUE) {
						...
						_tmp102_ = FALSE;
						_tmp105_ = i;
						_tmp106_ = self->priv->type_argument_list;
						_tmp107_ = vala_collection_get_size ((ValaCollection*) _tmp106_);
						_tmp108_ = _tmp107_;
						if (!(_tmp105_ < _tmp108_)) {
							break;
						}
						_tmp109_ = self->priv->type_argument_list;
						_tmp110_ = i;
						_tmp111_ = vala_list_get (_tmp109_, _tmp110_);
						type_arg = (ValaDataType*) _tmp111_;
						_tmp112_ = target_type;
						_tmp113_ = vala_data_type_get_type_arguments (_tmp112_);
						_tmp114_ = _tmp113_;
						_tmp115_ = i;
						_tmp116_ = vala_list_get (_tmp114_, _tmp115_);
						_tmp117_ = (ValaDataType*) _tmp116_;
						_vala_iterable_unref0 (_tmp114_);
						target_type_arg = _tmp117_;
						_tmp118_ = type_arg;
						_tmp119_ = target_type_arg;
						_tmp120_ = vala_data_type_compatible (_tmp118_, _tmp119_);
						if (!_tmp120_) {
							result = FALSE;
	...
	_tmp122_ = self->priv->_data_type;
	if (VALA_IS_STRUCT (_tmp122_)) {
		ValaDataType* _tmp123_;
		ValaTypeSymbol* _tmp124_;
		_tmp123_ = target_type;
		_tmp124_ = _tmp123_->priv->_data_type;
		_tmp121_ = VALA_IS_STRUCT (_tmp124_);
	} else {
		_tmp121_ = FALSE;
	}
	_tmp125_ = _tmp121_;
	if (_tmp125_) {
		...
		gboolean _tmp143_;
		gboolean _tmp150_;
		_tmp126_ = self->priv->_data_type;
		_tmp127_ = _vala_code_node_ref0 (VALA_STRUCT (_tmp126_));
		expr_struct = _tmp127_;
		_tmp128_ = target_type;
		_tmp129_ = _tmp128_->priv->_data_type;
		_tmp130_ = _vala_code_node_ref0 (VALA_STRUCT (_tmp129_));
		expect_struct = _tmp130_;
		_tmp132_ = expr_struct;
		_tmp133_ = vala_struct_is_integer_type (_tmp132_);
		if (_tmp133_) {
			ValaStruct* _tmp134_;
			gboolean _tmp135_ = FALSE;
			_tmp134_ = expect_struct;
			_tmp135_ = vala_struct_is_floating_type (_tmp134_);
			_tmp131_ = _tmp135_;
		} else {
			_tmp131_ = FALSE;
		}
		...
		_tmp139_ = expr_struct;
		_tmp140_ = vala_struct_is_integer_type (_tmp139_);
		if (_tmp140_) {
			ValaStruct* _tmp141_;
			gboolean _tmp142_ = FALSE;
			_tmp141_ = expect_struct;
			_tmp142_ = vala_struct_is_integer_type (_tmp141_);
			_tmp138_ = _tmp142_;
		} else {
			_tmp138_ = FALSE;
		}
		...
		if (_tmp143_) {
			...
			_tmp146_ = vala_struct_is_floating_type (_tmp145_);
			if (_tmp146_) {
				ValaStruct* _tmp147_;
				gboolean _tmp148_ = FALSE;
				_tmp147_ = expect_struct;
				_tmp148_ = vala_struct_is_floating_type (_tmp147_);
				_tmp144_ = _tmp148_;
			} else {
				_tmp144_ = FALSE;
			}
		...
		if (_tmp150_) {
			...
			ValaStruct* _tmp153_;
			gint _tmp154_ = 0;
			_tmp151_ = expr_struct;
			_tmp152_ = vala_struct_get_rank (_tmp151_);
			_tmp153_ = expect_struct;
			_tmp154_ = vala_struct_get_rank (_tmp153_);
	...
	_tmp157_ = self->priv->_data_type;
	if (_tmp157_ != NULL) {
		ValaDataType* _tmp158_;
		ValaTypeSymbol* _tmp159_;
		_tmp158_ = target_type;
		_tmp159_ = _tmp158_->priv->_data_type;
		_tmp156_ = _tmp159_ != NULL;
	} else {
		_tmp156_ = FALSE;
	}
	_tmp160_ = _tmp156_;
	if (_tmp160_) {
		...
		_tmp161_ = self->priv->_data_type;
		_tmp162_ = target_type;
		_tmp163_ = _tmp162_->priv->_data_type;
		_tmp164_ = vala_typesymbol_is_subtype_of (_tmp161_, _tmp163_);
		_tmp155_ = _tmp164_;
	} else {
		_tmp155_ = FALSE;
	}
...
static ValaDataType* vala_data_type_real_get_actual_type (ValaDataType* self, ValaDataType* derived_instance_type, ValaMemberAccess* method_access, ValaCodeNode* node_reference) {
	...
	if (VALA_IS_GENERIC_TYPE (_tmp6_)) {
		...
		_tmp11_ = vala_semantic_analyzer_get_actual_type (_tmp7_, _tmp8_, VALA_GENERIC_TYPE (_tmp9_), _tmp10_);
