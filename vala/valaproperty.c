...
static void vala_property_find_base_properties (ValaProperty* self) {
	...
	if (VALA_IS_CLASS (_tmp2_)) {
		...
		_tmp4_ = _tmp3_;
		vala_property_find_base_interface_property (self, VALA_CLASS (_tmp4_));
		...
		if (_tmp8_) {
			...
			_tmp10_ = _tmp9_;
			vala_property_find_base_class_property (self, VALA_CLASS (_tmp10_));
		}
	} else {
		ValaSymbol* _tmp11_;
		ValaSymbol* _tmp12_;
		...
		while (TRUE) {
			...
			if (VALA_IS_INTERFACE (_tmp13_)) {
				...
				if (VALA_IS_PROPERTY (_tmp22_)) {
					...
					gboolean _tmp26_;
					_tmp23_ = sym;
					_tmp24_ = _vala_code_node_ref0 (VALA_PROPERTY (_tmp23_));
...
static gboolean vala_property_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp4_) {
		...
		if (VALA_IS_CLASS (_tmp6_)) {
			...
			_tmp8_ = _tmp7_;
			_tmp9_ = _vala_code_node_ref0 (VALA_CLASS (_tmp8_));
			cl = _tmp9_;
			_tmp10_ = cl;
...
"ces");
		...
		if (_tmp19_) {
			...
			if (!VALA_IS_CLASS (_tmp22_)) {
				...
				_tmp24_ = _tmp23_;
				_tmp20_ = !VALA_IS_INTERFACE (_tmp24_);
			} else {
				_tmp20_ = FALSE;
			}
			_tmp25_ = _tmp20_;
...
"es");
			...
			if (VALA_IS_CLASS (_tmp29_)) {
				...
				_tmp31_ = _tmp30_;
				_tmp32_ = _vala_code_node_ref0 (VALA_CLASS (_tmp31_));
				cl = _tmp32_;
				_tmp33_ = cl;
			...
			if (_tmp38_) {
				...
				if (_tmp44_ == VALA_SYMBOL_ACCESSIBILITY_PROTECTED) {
					...
					if (!VALA_IS_CLASS (_tmp47_)) {
						...
						_tmp49_ = _tmp48_;
						_tmp45_ = !VALA_IS_INTERFACE (_tmp49_);
					} else {
						_tmp45_ = FALSE;
					}
					_tmp50_ = _tmp45_;
