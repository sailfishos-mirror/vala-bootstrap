...
static gboolean vala_assignment_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp9_) {
		...
		_tmp11_ = _tmp10_;
		_tmp4_ = VALA_IS_EXPRESSION_STATEMENT (_tmp11_);
	} else {
		_tmp4_ = FALSE;
	}
	_tmp12_ = _tmp4_;
	if (_tmp12_) {
		...
		_tmp14_ = _tmp13_;
		_tmp15_ = _vala_code_node_ref0 (VALA_TUPLE (_tmp14_));
		tuple = _tmp15_;
	...
	_tmp112_ = _tmp111_;
	if (VALA_IS_MEMBER_ACCESS (_tmp112_)) {
		...
		if (VALA_IS_SIGNAL (_tmp121_)) {
			...
			_tmp124_ = _tmp123_;
			_tmp118_ = VALA_IS_DYNAMIC_PROPERTY (_tmp124_);
		}
		_tmp125_ = _tmp118_;
		if (!_tmp125_) {
		...
		_tmp169_ = _tmp168_;
		if (VALA_IS_DYNAMIC_SIGNAL (_tmp169_)) {
			...
			if (VALA_IS_SIGNAL (_tmp177_)) {
				...
				_tmp185_ = _tmp184_;
				_tmp186_ = _vala_code_node_ref0 (VALA_SIGNAL (_tmp185_));
				sig = _tmp186_;
		...
		_tmp210_ = _tmp209_;
		if (VALA_IS_ELEMENT_ACCESS (_tmp210_)) {
			...
			_tmp212_ = _tmp211_;
			_tmp213_ = _vala_code_node_ref0 (VALA_ELEMENT_ACCESS (_tmp212_));
			ea = _tmp213_;
			_tmp214_ = ea;
			...
			if (_tmp220_ == _tmp226_) {
				...
				if (VALA_IS_MEMBER_ACCESS (_tmp233_)) {
					...
					_tmp238_ = _tmp237_;
					_tmp230_ = VALA_IS_SIGNAL (_tmp238_);
				} else {
					_tmp230_ = FALSE;
				}
				_tmp239_ = _tmp230_;
				if (_tmp239_) {
					...
					_tmp242_ = _tmp241_;
					_tmp243_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp242_));
					ma = _tmp243_;
					_tmp244_ = ea;
					...
					_tmp248_ = _tmp247_;
					_tmp249_ = _vala_code_node_ref0 (VALA_SIGNAL (_tmp248_));
					sig = _tmp249_;
					...
					_tmp268_ = _tmp267_;
					_tmp269_ = VALA_IS_METHOD (_tmp268_);
			...
			_tmp310_ = _tmp309_;
			if (VALA_IS_POINTER_INDIRECTION (_tmp310_)) {
	...
	if (_tmp324_ != VALA_ASSIGNMENT_OPERATOR_SIMPLE) {
		...
		_tmp326_ = _tmp325_;
		_tmp323_ = VALA_IS_MEMBER_ACCESS (_tmp326_);
	} else {
		_tmp323_ = FALSE;
	}
	_tmp327_ = _tmp323_;
	if (_tmp327_) {
		...
		_tmp329_ = _tmp328_;
		_tmp330_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp329_));
		ma = _tmp330_;
		_tmp331_ = ma;
		_tmp332_ = vala_expression_get_symbol_reference ((ValaExpression*) _tmp331_);
		_tmp333_ = _tmp332_;
		if (!VALA_IS_SIGNAL (_tmp333_)) {
	...
	if (VALA_IS_SIGNAL (_tmp391_)) {
		...
		_tmp395_ = _tmp394_;
		_tmp396_ = _vala_code_node_ref0 (VALA_SIGNAL (_tmp395_));
		sig = _tmp396_;
		_tmp397_ = vala_assignment_get_right (self);
		_tmp398_ = _tmp397_;
		_tmp399_ = vala_expression_get_symbol_reference (_tmp398_);
		_tmp400_ = _tmp399_;
		_tmp401_ = _vala_code_node_ref0 (VALA_IS_METHOD (_tmp400_) ? ((ValaMethod*) _tmp400_) : NULL);
		m = _tmp401_;
		_tmp402_ = m;
		if (_tmp402_ == NULL) {
		...
		_tmp407_ = sig;
		_tmp408_ = _vala_code_node_ref0 (VALA_IS_DYNAMIC_SIGNAL (_tmp407_) ? ((ValaDynamicSignal*) _tmp407_) : NULL);
		dynamic_sig = _tmp408_;
		_tmp409_ = vala_assignment_get_right (self);
		_tmp410_ = _tmp409_;
		_tmp411_ = _vala_code_node_ref0 (VALA_IS_MEMBER_ACCESS (_tmp410_) ? ((ValaMemberAccess*) _tmp410_) : NULL);
		right_ma = _tmp411_;
		...
		if (_tmp412_ != NULL) {
			...
			_tmp438_ = _tmp437_;
			_tmp439_ = vala_object_type_new (VALA_OBJECT_TYPE_SYMBOL (_tmp438_));
			_tmp440_ = _tmp439_;
			...
			if (!_tmp453_) {
				...
				_tmp457_ = _tmp456_;
				_tmp458_ = _vala_code_node_ref0 (VALA_DELEGATE_TYPE (_tmp457_));
		...
		_tmp501_ = _tmp500_;
		if (VALA_IS_MEMBER_ACCESS (_tmp501_)) {
			...
			_tmp503_ = _tmp502_;
			_tmp504_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp503_));
			ma = _tmp504_;
			_tmp505_ = ma;
			_tmp506_ = vala_expression_get_symbol_reference ((ValaExpression*) _tmp505_);
			_tmp507_ = _tmp506_;
			if (VALA_IS_PROPERTY (_tmp507_)) {
				...
				_tmp510_ = _tmp509_;
				_tmp511_ = _vala_code_node_ref0 (VALA_PROPERTY (_tmp510_));
				prop = _tmp511_;
				_tmp512_ = prop;
				_tmp513_ = _vala_code_node_ref0 (VALA_IS_DYNAMIC_PROPERTY (_tmp512_) ? ((ValaDynamicProperty*) _tmp512_) : NULL);
				...
				if (_tmp532_ == NULL) {
					...
					if (!_tmp538_) {
						...
						_tmp544_ = _tmp543_;
						_tmp545_ = VALA_IS_CREATION_METHOD (_tmp544_);
				...
				if (_tmp552_) {
					...
					if (_tmp572_) {
						...
						_tmp577_ = _tmp576_;
						_tmp562_ = VALA_IS_CREATION_METHOD (_tmp577_);
					...
					if (_tmp578_) {
						...
						_tmp590_ = _tmp589_;
						_tmp591_ = _tmp583_ != VALA_SYMBOL (_tmp590_);
...
"e) constructor chain up");
				...
				if (_tmp611_) {
					...
					if (VALA_IS_METHOD (_tmp620_)) {
						...
						_tmp623_ = _tmp622_;
						_tmp616_ = VALA_IS_DELEGATE_TYPE (_tmp623_);
					} else {
						_tmp616_ = FALSE;
					}
					_tmp624_ = _tmp616_;
					if (_tmp624_) {
						...
						_tmp628_ = _tmp627_;
						_tmp629_ = _vala_code_node_ref0 (VALA_METHOD (_tmp628_));
						m = _tmp629_;
						_tmp630_ = variable;
						_tmp631_ = vala_variable_get_variable_type (_tmp630_);
						_tmp632_ = _tmp631_;
						_tmp633_ = _vala_code_node_ref0 (VALA_DELEGATE_TYPE (_tmp632_));
						dt = _tmp633_;
						_tmp634_ = dt;
			...
			if (_tmp668_) {
				...
				if (!VALA_IS_PROPERTY (_tmp696_)) {
					...
					if (_tmp701_) {
						...
						_tmp706_ = _tmp705_;
						if (!VALA_IS_POINTER_TYPE (_tmp706_)) {
			...
			_tmp723_ = _tmp722_;
			_tmp724_ = _vala_code_node_ref0 (VALA_IS_MEMBER_ACCESS (_tmp723_) ? ((ValaMemberAccess*) _tmp723_) : NULL);
			right_ma = _tmp724_;
			_tmp726_ = right_ma;
			if (_tmp726_ != NULL) {
			...
			if (_tmp733_) {
				...
				_tmp737_ = _tmp736_;
				if (VALA_IS_LOCAL_VARIABLE (_tmp737_)) {
					_tmp734_ = TRUE;
				} else {
					...
					_tmp740_ = _tmp739_;
					_tmp734_ = VALA_IS_PARAMETER (_tmp740_);
				}
				_tmp741_ = _tmp734_;
				if (_tmp741_) {
					...
					if (VALA_IS_FIELD (_tmp746_)) {
						...
						_tmp749_ = _tmp748_;
						_tmp750_ = _vala_code_node_ref0 (VALA_FIELD (_tmp749_));
						f = _tmp750_;
						_tmp751_ = f;
						...
						if (_tmp753_ == VALA_MEMBER_BINDING_STATIC) {
							...
							_tmp758_ = _tmp757_;
							_tmp759_ = _vala_code_node_ref0 (VALA_IS_MEMBER_ACCESS (_tmp758_) ? ((ValaMemberAccess*) _tmp758_) : NULL);
							ma_inner = _tmp759_;
							_tmp760_ = right_ma;
							_tmp761_ = vala_member_access_get_inner (_tmp760_);
							_tmp762_ = _tmp761_;
							_tmp763_ = _vala_code_node_ref0 (VALA_IS_MEMBER_ACCESS (_tmp762_) ? ((ValaMemberAccess*) _tmp762_) : NULL);
			...
			if (VALA_IS_ELEMENT_ACCESS (_tmp791_)) {
				...
				_tmp793_ = _tmp792_;
				_tmp794_ = _vala_code_node_ref0 (VALA_ELEMENT_ACCESS (_tmp793_));
				ea = _tmp794_;
				...
				if (_tmp824_) {
					...
					_tmp829_ = _tmp828_;
					if (VALA_IS_ARRAY_TYPE (_tmp829_)) {
						...
						_tmp834_ = _tmp833_;
						_tmp835_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp834_));
						array_type = _tmp835_;
						_tmp836_ = array_type;
					...
					if (!VALA_IS_POINTER_TYPE (_tmp852_)) {
...
static void vala_assignment_real_get_defined_variables (ValaCodeNode* base, ValaCollection* collection) {
	...
	_tmp9_ = _tmp8_;
	_tmp10_ = _vala_code_node_ref0 (VALA_IS_LOCAL_VARIABLE (_tmp9_) ? ((ValaLocalVariable*) _tmp9_) : NULL);
	local = _tmp10_;
	_tmp11_ = vala_assignment_get_left (self);
	_tmp12_ = _tmp11_;
	_tmp13_ = vala_expression_get_symbol_reference (_tmp12_);
	_tmp14_ = _tmp13_;
	_tmp15_ = _vala_code_node_ref0 (VALA_IS_PARAMETER (_tmp14_) ? ((ValaParameter*) _tmp14_) : NULL);
	param = _tmp15_;
	_tmp16_ = local;
	if (_tmp16_ != NULL) {
