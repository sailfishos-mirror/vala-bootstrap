...
static void vala_gobject_module_real_visit_class (ValaCodeVisitor* base, ValaClass* cl) {
	...
	_tmp0_ = cl;
	VALA_CODE_VISITOR_CLASS (vala_gobject_module_parent_class)->visit_class ((ValaCodeVisitor*) VALA_GTYPE_MODULE (self), _tmp0_);
	_tmp1_ = cl;
		...
		while (TRUE) {
			...
			if (_tmp68_ != NULL) {
				...
				if (_tmp100_ != NULL) {
					...
					_tmp105_ = _tmp104_;
					_tmp106_ = _vala_code_node_ref0 (VALA_INTERFACE (_tmp105_));
					base_type = _tmp106_;
					_tmp107_ = prop;
			...
			if (_tmp154_) {
				...
				_tmp159_ = _tmp158_;
				_tmp160_ = _vala_code_node_ref0 (VALA_IS_STRUCT (_tmp159_) ? ((ValaStruct*) _tmp159_) : NULL);
				st = _tmp160_;
				...
				_tmp225_ = _tmp224_;
				_tmp226_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp225_) ? ((ValaArrayType*) _tmp225_) : NULL);
				array_type = _tmp226_;
				_tmp228_ = array_type;
				if (_tmp228_ != NULL) {
...
static void vala_gobject_module_add_set_property_function (ValaGObjectModule* self, ValaClass* cl) {
	...
	props = _tmp41_;
	{
		...
		while (TRUE) {
			...
			_tmp158_ = _tmp157_;
			if (VALA_IS_ARRAY_TYPE (_tmp158_)) {
				...
				_tmp161_ = _tmp160_;
				_tmp162_ = vala_array_type_get_element_type (VALA_ARRAY_TYPE (_tmp161_));
				_tmp163_ = _tmp162_;
...
static void vala_gobject_module_real_visit_constructor (ValaCodeVisitor* base, ValaConstructor* c) {
	...
	_tmp5_ = _tmp4_;
	_tmp6_ = _vala_code_node_ref0 (VALA_CLASS (_tmp5_));
	cl = _tmp6_;
	_tmp7_ = c;
...
static gchar* vala_gobject_module_real_get_dynamic_property_getter_cname (ValaCCodeBaseModule* base, ValaDynamicProperty* prop) {
	...
	if (_tmp13_) {
		...
		gchar* _tmp15_ = NULL;
		_tmp14_ = prop;
		_tmp15_ = VALA_CCODE_BASE_MODULE_CLASS (vala_gobject_module_parent_class)->get_dynamic_property_getter_cname ((ValaCCodeBaseModule*) VALA_GTYPE_MODULE (self), _tmp14_);
		result = _tmp15_;
		return result;
	}
	_tmp16_ = prop;
...
static gchar* vala_gobject_module_real_get_dynamic_property_setter_cname (ValaCCodeBaseModule* base, ValaDynamicProperty* prop) {
	...
	if (_tmp13_) {
		...
		gchar* _tmp15_ = NULL;
		_tmp14_ = prop;
		_tmp15_ = VALA_CCODE_BASE_MODULE_CLASS (vala_gobject_module_parent_class)->get_dynamic_property_setter_cname ((ValaCCodeBaseModule*) VALA_GTYPE_MODULE (self), _tmp14_);
		result = _tmp15_;
		return result;
	}
	_tmp16_ = prop;
...
static gchar* vala_gobject_module_real_get_dynamic_signal_connect_wrapper_name (ValaCCodeBaseModule* base, ValaDynamicSignal* sig) {
	...
	if (_tmp13_) {
		...
		gchar* _tmp15_ = NULL;
		_tmp14_ = sig;
		_tmp15_ = VALA_CCODE_BASE_MODULE_CLASS (vala_gobject_module_parent_class)->get_dynamic_signal_connect_wrapper_name ((ValaCCodeBaseModule*) VALA_GTYPE_MODULE (self), _tmp14_);
		result = _tmp15_;
		return result;
	}
	_tmp16_ = sig;
...
static void vala_gobject_module_generate_gobject_connect_wrapper (ValaGObjectModule* self, ValaDynamicSignal* sig, gboolean after) {
	...
	_tmp4_ = _tmp3_;
	_tmp5_ = _vala_code_node_ref0 (VALA_METHOD (_tmp4_));
	m = _tmp5_;
	_tmp6_ = sig;
...
static void vala_gobject_module_real_visit_property (ValaCodeVisitor* base, ValaProperty* prop) {
	...
	_tmp0_ = prop;
	VALA_CODE_VISITOR_CLASS (vala_gobject_module_parent_class)->visit_property ((ValaCodeVisitor*) VALA_GTYPE_MODULE (self), _tmp0_);
	_tmp2_ = prop;
...
static gboolean vala_gobject_module_real_is_gobject_property (ValaCCodeBaseModule* base, ValaProperty* prop) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = _vala_code_node_ref0 (VALA_IS_OBJECT_TYPE_SYMBOL (_tmp2_) ? ((ValaObjectTypeSymbol*) _tmp2_) : NULL);
	type_sym = _tmp3_;
	_tmp5_ = type_sym;
	if (_tmp5_ == NULL) {
		_tmp4_ = TRUE;
	...
	if (VALA_IS_ARRAY_TYPE (_tmp37_)) {
		...
		_tmp40_ = _tmp39_;
		_tmp41_ = vala_array_type_get_element_type (VALA_ARRAY_TYPE (_tmp40_));
		_tmp42_ = _tmp41_;
	...
	_tmp51_ = _tmp50_;
	_tmp52_ = _vala_code_node_ref0 (VALA_IS_DELEGATE_TYPE (_tmp51_) ? ((ValaDelegateType*) _tmp51_) : NULL);
	d = _tmp52_;
	_tmp54_ = d;
	if (_tmp54_ != NULL) {
	...
	if (VALA_IS_INTERFACE (_tmp79_)) {
		...
		ValaAttribute* _tmp81_ = NULL;
		ValaAttribute* _tmp82_;
		_tmp80_ = type_sym;
		_tmp81_ = vala_code_node_get_attribute ((ValaCodeNode*) _tmp80_, "DBus");
		_tmp82_ = _tmp81_;
...
static void vala_gobject_module_real_visit_method_call (ValaCodeVisitor* base, ValaMethodCall* expr) {
	...
	if (VALA_IS_MEMBER_ACCESS (_tmp2_)) {
		...
		if (_tmp14_ != NULL) {
			...
			_tmp11_ = _tmp19_ == VALA_SYMBOL (_tmp20_);
		} else {
			_tmp11_ = FALSE;
		}
		_tmp21_ = _tmp11_;
		...
		if (_tmp30_) {
			...
			_tmp31_ = expr;
			VALA_CODE_VISITOR_CLASS (vala_gobject_module_parent_class)->visit_method_call ((ValaCodeVisitor*) VALA_GTYPE_MODULE (self), _tmp31_);
			...
			if (_tmp67_ == VALA_SYMBOL (_tmp68_)) {
				{
					...
					while (TRUE) {
						...
						_tmp80_ = arg;
						_tmp81_ = _vala_code_node_ref0 (VALA_IS_NAMED_ARGUMENT (_tmp80_) ? ((ValaNamedArgument*) _tmp80_) : NULL);
						...
						prop = VALA_IS_PROPERTY (_tmp91_) ? ((ValaProperty*) _tmp91_) : NULL;
						_tmp92_ = prop;
						if (_tmp92_ == NULL) {
...
"ain up", _tmp112_);
	...
	_tmp137_ = expr;
	VALA_CODE_VISITOR_CLASS (vala_gobject_module_parent_class)->visit_method_call ((ValaCodeVisitor*) VALA_GTYPE_MODULE (self), _tmp137_);
}
