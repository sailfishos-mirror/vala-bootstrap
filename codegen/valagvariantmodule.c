	...
	if (_tmp6_ != NULL) {
		...
		if (_tmp23_) {
			...
			if (_tmp27_ != NULL) {
				...
				_tmp34_ = _tmp33_;
				_tmp35_ = _vala_code_node_ref0 (VALA_IS_STRUCT (_tmp34_) ? ((ValaStruct*) _tmp34_) : NULL);
				st = _tmp35_;
				_tmp36_ = datatype;
				_tmp37_ = vala_data_type_get_data_type (_tmp36_);
				_tmp38_ = _tmp37_;
				_tmp39_ = _vala_code_node_ref0 (VALA_IS_ENUM (_tmp38_) ? ((ValaEnum*) _tmp38_) : NULL);
				en = _tmp39_;
				_tmp41_ = sig;
				if (_tmp41_ == NULL) {
					ValaStruct* _tmp42_;
...
static void vala_gvariant_module_real_visit_enum (ValaCodeVisitor* base, ValaEnum* en) {
	...
	_tmp0_ = en;
	VALA_CODE_VISITOR_CLASS (vala_gvariant_module_parent_class)->visit_enum ((ValaCodeVisitor*) VALA_GASYNC_MODULE (self), _tmp0_);
	_tmp1_ = en;
...
static gboolean vala_gvariant_module_real_generate_enum_declaration (ValaCCodeBaseModule* base, ValaEnum* en, ValaCCodeFile* decl_space) {
	...
	_tmp0_ = en;
	_tmp1_ = decl_space;
	_tmp2_ = VALA_CCODE_BASE_MODULE_CLASS (vala_gvariant_module_parent_class)->generate_enum_declaration ((ValaCCodeBaseModule*) VALA_GASYNC_MODULE (self), _tmp0_, _tmp1_);
	if (_tmp2_) {
		ValaEnum* _tmp3_;
...
static ValaCCodeExpression* vala_gvariant_module_generate_enum_value_from_string (ValaGVariantModule* self, ValaEnumValueType* type, ValaCCodeExpression* expr, ValaCCodeExpression* error_expr) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = _vala_code_node_ref0 (VALA_IS_ENUM (_tmp2_) ? ((ValaEnum*) _tmp2_) : NULL);
	en = _tmp3_;
	_tmp4_ = en;
...
static ValaCCodeExpression* vala_gvariant_module_real_deserialize_expression (ValaCCodeBaseModule* base, ValaDataType* type, ValaCCodeExpression* variant_expr, ValaCCodeExpression* expr, ValaCCodeExpression* error_expr, gboolean* may_fail) {
	...
	if (_tmp3_) {
		...
		_tmp9_ = _result_;
		_tmp10_ = error_expr;
		_tmp11_ = vala_gvariant_module_generate_enum_value_from_string (self, VALA_IS_ENUM_VALUE_TYPE (_tmp8_) ? ((ValaEnumValueType*) _tmp8_) : NULL, _tmp9_, _tmp10_);
		_vala_ccode_node_unref0 (_result_);
		_result_ = _tmp11_;
		_vala_may_fail = TRUE;
	} else {
		...
		if (_tmp17_) {
			...
			if (VALA_IS_ARRAY_TYPE (_tmp21_)) {
				...
				_tmp24_ = expr;
				_tmp25_ = vala_gvariant_module_deserialize_array (self, VALA_ARRAY_TYPE (_tmp22_), _tmp23_, _tmp24_);
				_vala_ccode_node_unref0 (_result_);
				_result_ = _tmp25_;
			} else {
				...
				if (VALA_IS_STRUCT (_tmp28_)) {
					...
					_tmp31_ = _tmp30_;
					_tmp32_ = _vala_code_node_ref0 (VALA_STRUCT (_tmp31_));
					st = _tmp32_;
					_tmp33_ = st;
					...
					_tmp64_ = type;
					if (VALA_IS_OBJECT_TYPE (_tmp64_)) {
						...
						if (_tmp70_) {
							...
							if (_tmp84_) {
								...
								_tmp87_ = vala_gvariant_module_deserialize_hash_table (self, VALA_OBJECT_TYPE (_tmp85_), _tmp86_);
								_vala_ccode_node_unref0 (_result_);
								_result_ = _tmp87_;
							}
						}
...
static ValaCCodeExpression* vala_gvariant_module_real_serialize_expression (ValaCCodeBaseModule* base, ValaDataType* type, ValaCCodeExpression* expr) {
	...
	if (_tmp3_) {
		...
		_tmp5_ = type;
		_tmp6_ = expr;
		_tmp7_ = vala_gvariant_module_generate_enum_value_to_string (self, VALA_IS_ENUM_VALUE_TYPE (_tmp5_) ? ((ValaEnumValueType*) _tmp5_) : NULL, _tmp6_);
		_vala_ccode_node_unref0 (_result_);
		_result_ = _tmp7_;
		_tmp8_ = basic_type;
		_tmp9_ = _result_;
		...
		if (_tmp16_) {
			...
			if (VALA_IS_ARRAY_TYPE (_tmp20_)) {
				...
				_tmp21_ = type;
				_tmp22_ = expr;
				_tmp23_ = vala_gvariant_module_serialize_array (self, VALA_ARRAY_TYPE (_tmp21_), _tmp22_);
				_vala_ccode_node_unref0 (_result_);
				_result_ = _tmp23_;
			} else {
				...
				if (VALA_IS_STRUCT (_tmp26_)) {
					...
					_tmp36_ = _tmp35_;
					_tmp37_ = st_expr;
					_tmp38_ = vala_gvariant_module_serialize_struct (self, VALA_STRUCT (_tmp36_), _tmp37_);
					_vala_ccode_node_unref0 (_result_);
					_result_ = _tmp38_;
					_vala_ccode_node_unref0 (st_expr);
				} else {
					ValaDataType* _tmp39_;
					_tmp39_ = type;
					if (VALA_IS_OBJECT_TYPE (_tmp39_)) {
						ValaDataType* _tmp40_;
						...
						if (_tmp45_) {
							...
							if (_tmp59_) {
								...
								_tmp60_ = type;
								_tmp61_ = expr;
								_tmp62_ = vala_gvariant_module_serialize_hash_table (self, VALA_OBJECT_TYPE (_tmp60_), _tmp61_);
								_vala_ccode_node_unref0 (_result_);
								_result_ = _tmp62_;
							}
						}
