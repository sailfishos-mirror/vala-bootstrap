...
static void vala_ccode_control_flow_module_real_visit_switch_label (ValaCodeVisitor* base, ValaSwitchLabel* label) {
	...
	_tmp4_ = _tmp3_;
	_tmp5_ = vala_switch_statement_get_expression (VALA_SWITCH_STATEMENT (_tmp4_));
	_tmp6_ = _tmp5_;
...
static void vala_ccode_control_flow_module_real_visit_loop (ValaCodeVisitor* base, ValaLoop* stmt) {
	...
	_tmp13_ = stmt;
	_tmp14_ = vala_loop_get_body (_tmp13_);
	_tmp15_ = _tmp14_;
	vala_code_node_emit ((ValaCodeNode*) _tmp15_, (ValaCodeGenerator*) self);
	_tmp16_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp17_ = _tmp16_;
	vala_ccode_function_close (_tmp17_);
}
...
static void vala_ccode_control_flow_module_real_visit_foreach_statement (ValaCodeVisitor* base, ValaForeachStatement* stmt) {
	...
	if (VALA_IS_ARRAY_TYPE (_tmp45_)) {
		...
		_tmp148_ = _tmp147_;
		if (VALA_IS_ARRAY_TYPE (_tmp148_)) {
			...
			_tmp151_ = _tmp150_;
			_tmp152_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp151_));
